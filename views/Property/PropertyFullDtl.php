...
foreach ($Propertyrows as $Propertyrow) 
{
   ...
   $countrycode			        = $Propertyrow["COUNTRY_CODE_NEW"] ? $Propertyrow["COUNTRY_CODE_NEW"]         : "";
      ...
      <div class="card h-100 mb-0">
         <div class="card-body">
            <div class="card-title"><a class="text-dark" href="#">
                <h4 class="heading-primary"><?php echo $apartment_no; ?>|<?php echo $building; ?>|<?php echo $ProjectName; ?> | <?php echo $countrycode; ?></h4>
              </a>

              <div class="form-row mt-3">
                  <div class="form-group col-6" style='display:none;'>
                      <label>Project</label>
                      <input class="form-control" type="text" name="building" id="building" value="<?php echo $building;?>" readonly>
                  </div>  
                  <div class="form-group col-md-2" style='display:none;' >
                      <label>Unit</label>
                      <input class="form-control" type="text" name="unitapartmentno" id='unitapartmentno' value="<?php echo $apartment_no;?>" readonly>
                              ...
                              <div class="card-body">
                                 ...
                                 <div class="table-responsive">
                                    <table class="table">
                                       ...
                                       <tr>
                                          <td style="min-width: 155px;">IP Global client fee <a class="text-info" data-toggle="modal" data-target="#infoModal">
                                            <i class="fa fa-info-circle" aria-hidden="true"></i>
                                            </a>
                                        </td>
                                          <td>
                                          <div class="input-group">  
                                            <input class="form-control" type='text' name='ipglbclientfee' id='ipglbclientfee' numeric='true' value='<?php echo $ip_glb_client_fee; ?>' calc='InitialCosts' >
                                                <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">Per Unit</span>
                                              </div>
                                            </div>
                                          </td>
                                          <td><input class="form-control" type='text' name='ipglbclientfeeAmt' id='ipglbclientfeeAmt' numeric='true' value='<?php echo $ipglbclientfeeAmt; ?>' readonly >&nbsp;&nbsp;</td>
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type='text' name='ReservationDeposit' id='ReservationDeposit' value='<?php echo $ReservationDeposit; ?>' calc='InitialCosts'>
                                                <div class="input-group-append">
                                          ...
                                          <td><input class="form-control" type='text' name='ReservationDepositAmt' id='ReservationDepositAmt' value='<?php echo $ReservationDepositAmt; ?>' readonly >&nbsp;&nbsp;</td>
                                       ...
                                       <tr>
                                          <td>Conveyancing fees(Inc VAT) <a class="text-info" data-toggle="modal" data-target="#infoModal">
                                            <i class="fa fa-info-circle" aria-hidden="true"></i>
                                            </a></td>
                                          <td>
                                          <div class="input-group">
                                            <input class="form-control" type='text' name='Conveyancingfees' id='Conveyancingfees' value='<?php echo $Conveyancingfees; ?>' calc='InitialCosts' >
                                                <div class="input-group-append">
                                          ...
                                          <td><input class="form-control" type='text' name='ConveyancingfeesAmt' id='ConveyancingfeesAmt' value='<?php echo $ConveyancingfeesAmt; ?>' readonly >&nbsp;&nbsp;</td>
                                       ...
                                       <tr>
                                          <td style="min-width: 155px;">Land registry fees <a class="text-info" data-toggle="modal" data-target="#infoModal">
                                            <i class="fa fa-info-circle" aria-hidden="true"></i>
                                            </a></td>
                                          <td>

                                          <div class="input-group">
                                                <input class="form-control" type='text' name='Landregistryfees' id='Landregistryfees' value='<?php echo $Landregistryfees; ?>' calc='InitialCosts' >    
                                                <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">based on UK Dpt of Land Reg. Req</span>
                                              </div>
                                            </div>  
                                          </td>
                                          <td><input class="form-control" type='text' name='LandregistryfeesAmt' id='LandregistryfeesAmt' value='<?php echo $LandregistryfeesAmt; ?>' readonly>&nbsp;&nbsp;</td>
                                       ...
                                       <tr>
                                          <td style="min-width: 155px;">Engrossment fees <a class="text-info" data-toggle="modal" data-target="#infoModal">
                                            <i class="fa fa-info-circle" aria-hidden="true"></i>
                                            </a></td>
                                          <td>

                                          <div class="input-group">
                                                <input class="form-control" type='text' name='Engrossmentfees' id='Engrossmentfees' value='<?php echo $Engrossmentfees; ?>' calc='InitialCosts' >
                                                <div class="input-group-append">
                                          ...
                                          <td><input class="form-control" type='text' name='EngrossmentfeesAmt' id='EngrossmentfeesAmt' value='<?php echo $EngrossmentfeesAmt; ?>' readonly>&nbsp;&nbsp;</td>
                                       ...
                                       <tr>
                                          ...
                                          <td><span class='valhml1' ><?php echo $PaymentResExcAmount; ?></span><input class="form-control"  type='hidden' name='PaymentResExcAmount' id='PaymentResExcAmount' value='<?php echo $PaymentResExcAmount; ?>'></td>
                           ...
                           <div class="table-responsive">
                              <table class="table">
                                 <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input class="form-control" type='text' name='Finalcapitalpayment' id='Finalcapitalpayment' value='<?php echo $Finalcapitalpayment; ?>' calc='Finalcostcompletion' >
                                                <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">of Purchase Price</span>
                                              </div>
                                            </div>    
                                    </td>
                                    <td><input class="form-control" type='text' name='FinalcapitalpaymentAmt' id='FinalcapitalpaymentAmt' readonly value='<?php echo $FinalcapitalpaymentAmt; ?>'>&nbsp;&nbsp;</td>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input class="form-control" type='text' name='Stampduty' id='Stampduty' value='<?php echo $Stampduty; ?>' calc='Finalcostcompletion' >
                                                <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">Based on the Purchase Price</span>
                                              </div>
                                            </div>
                                    </td>
                                    <td><input class="form-control" type='text' name='StampdutyAmt' id='StampdutyAmt' readonly value='<?php echo $StampdutyAmt; ?>'>&nbsp;&nbsp;</td>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input class="form-control" type='text' name='LiquidExpatbrokercosts' id='LiquidExpatbrokercosts' value='<?php echo $LiquidExpatbrokercosts; ?>' calc='Finalcostcompletion' >
                                                <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">of the Loan Amount</span>
                                              </div>
                                            </div>
                                    </td>
                                    <td><input class="form-control" type='text' name='LiquidExpatbrokercostsAmt' id='LiquidExpatbrokercostsAmt' readonly value='<?php echo $LiquidExpatbrokercostsAmt; ?>'>&nbsp;&nbsp;</td>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input class="form-control" type='text' name='Lenderarrangementfee' id='Lenderarrangementfee' value='<?php echo $Lenderarrangementfee; ?>' calc='Finalcostcompletion' >
                                                <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">of the Loan Amount</span>
                                              </div>
                                            </div>
                                    </td>
                                    <td><input class="form-control" type='text' name='LenderarrangementfeeAmt' id='LenderarrangementfeeAmt' readonly value='<?php echo $LenderarrangementfeeAmt; ?>'>&nbsp;&nbsp;</td>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input class="form-control" type='text' name='Valuationfee' id='Valuationfee' value='<?php echo $Valuationfee; ?>' calc='Finalcostcompletion' >
                                                <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">Based on the Purchase Price</span>
                                              </div>
                                            </div>
                                    </td>
                                    <td><input class="form-control" type='text' name='ValuationfeeAmt' id='ValuationfeeAmt' readonly value='<?php echo $ValuationfeeAmt; ?>'>&nbsp;&nbsp;</td>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input class="form-control" type='text' name='Furniturepack' id='Furniturepack' value='<?php echo $Furniturepack; ?>' calc='Finalcostcompletion' >
                                                <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">Based on Unit Type</span>
                                              </div>
                                            </div>
                                    </td>
                                    <td><input class="form-control" type='text' name='FurniturepackAmt' id='FurniturepackAmt' readonly value='<?php echo $FurniturepackAmt; ?>'>&nbsp;&nbsp;</td>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input class="form-control" type='text' name='CompleteTenantfee' id='CompleteTenantfee' value='<?php echo $CompleteTenantfee; ?>' calc='Finalcostcompletion'>
                                                <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">Based on 1 Tenaunt</span>
                                              </div>
                                            </div>
                                    </td>
                                    <td><input class="form-control" type='text' name='CompleteTenantfeeAmt' id='CompleteTenantfeeAmt' readonly value='<?php echo $CompleteTenantfeeAmt; ?>'>&nbsp;&nbsp;</td>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input class="form-control" type='text' name='CompleteTenantagreementfee ' id='CompleteTenantagreementfee' value='<?php echo $CompleteTenantagreementfee; ?>' calc='Finalcostcompletion' >
                                                <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">Based on 1 Tenaunt</span>
                                              </div>
                                            </div>
                                    </td>
                                    <td><input class="form-control" type='text' name='CompleteTenantagreementfeeAmt' id='CompleteTenantagreementfeeAmt' readonly value='<?php echo $CompleteTenantagreementfeeAmt; ?>'>&nbsp;&nbsp;</td>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" type='text' name='CompleteHandoverfee' id='CompleteHandoverfee' value='<?php echo $CompleteHandoverfee; ?>' calc='Finalcostcompletion' >
                                                <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">Based on Unit Type</span>
                                              </div>
                                            </div>
                                    </td>
                                    <td><input class="form-control" type='text' name='CompleteHandoverfeeAmt' id='CompleteHandoverfeeAmt' readonly value='<?php echo $CompleteHandoverfeeAmt; ?>'>&nbsp;&nbsp;</td>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input class="form-control" type='text' name='CompleteInventoryfee' id='CompleteInventoryfee' value='<?php echo $CompleteInventoryfee; ?>' calc='Finalcostcompletion' >
                                                <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">Based on Unit Type</span>
                                              </div>
                                            </div>
                                    </td>
                                    <td><input class="form-control" type='text' name='CompleteInventoryfeeAmt' readonly id='CompleteInventoryfeeAmt' value='<?php echo $CompleteInventoryfeeAmt; ?>'>&nbsp;&nbsp;</td>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" type='text' name='CompleteReferenceCheck' id='CompleteReferenceCheck' value='<?php echo $CompleteReferenceCheck; ?>' calc='Finalcostcompletion' >
                                                <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">Based on 1 Tenaunt</span>
                                              </div>
                                            </div>
                                    </td>
                                    <td><input class="form-control" type='text' name='CompleteReferenceCheckAmt' id='CompleteReferenceCheckAmt' readonly value='<?php echo $CompleteReferenceCheckAmt; ?>'>&nbsp;&nbsp;</td>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input class="form-control" type='text' name='ClientFeeRebateComp' id='ClientFeeRebateComp' value='<?php echo $ClientFeeRebateComp; ?>' calc='Finalcostcompletion'>
                                                <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">Per Unit</span>
                                              </div>
                                            </div>
                                    </td>
                                    <td><input class="form-control" type='text' name='ClientFeeRebateCompAmt' id='ClientFeeRebateCompAmt' readonly  value='<?php echo $ClientFeeRebateCompAmt; ?>'>&nbsp;&nbsp;</td>
                                 ...
                                 <tr>
                                    ...
                                    <td ><span class='valhml2' ><?php echo $PaymentOnCompleteion;?></span><input class="form-control" type='hidden' name='PaymentOnCompleteion' id='PaymentOnCompleteion' value='<?php echo $PaymentOnCompleteion; ?>'></td>
                                 ...
                                 <tr>
                                    ...
                                    <td ><span class='valhml3' ><?php echo $TotalEquityRequired; ?></span><input class="form-control" type='hidden' name='TotalEquityRequired' id='TotalEquityRequired' value='<?php echo $TotalEquityRequired; ?>'></td>
                                 ...
                                 <tr>
                                    ...
                                    <td><span class='valhml4' ><?php echo $TotalMortgageAmount; ?></span><input class="form-control" type='hidden' name='TotalMortgageAmount' id='TotalMortgageAmount' value='<?php echo $TotalMortgageAmount; ?>'></td>
                           ...
                           <div class="table-responsive">
                              <table class="table">
                                 <tr>
                                    ...
                                    <td><span class='valhml5'><?php echo $Paymentonreservation; ?></span><input class="form-control" type='hidden' name='Paymentonreservation' id='Paymentonreservation' readonly value='<?php echo $Paymentonreservation; ?>'></td>
                                    <td>Mortgage principle</td>
                                    <td><span class='valhml6'><?php echo $MortgagePrincipleTotal; ?></span><input class="form-control" type='hidden' name='MortgagePrincipleTotal' id='MortgagePrincipleTotal' readonly value='<?php echo $MortgagePrincipleTotal; ?>'></td>
                                 </tr>
                                 <tr>
                                    <td>Further deposit</td>
                                    <td><span class='valhml7'><?php echo $FurtherdepositTotal; ?></span><input class="form-control" type='hidden' name='FurtherdepositTotal' id='FurtherdepositTotal' readonly value='<?php echo $FurtherdepositTotal; ?>'></td>
                                    <td>Monthly income</td>
                                    <td><span class='valhml8'><?php echo $MonthlyIncome; ?></span><input class="form-control" type='hidden' name='MonthlyIncome' id='MonthlyIncome' readonly value='<?php echo $MonthlyIncome; ?>'></td>
                                 </tr>
                                 <tr>
                                    <td>Payment on property completion</td>
                                    <td><span class='valhml9'><?php echo $PaymentPropComp; ?></span><input class="form-control" type='hidden' name='PaymentPropComp' id='PaymentPropComp' readonly value='<?php echo $PaymentPropComp; ?>'></td>
                                    <td>Mortgage Interest Only</td>
                                    <td><span class='valhml10'><?php echo $MortgageInterestOnly; ?></span><input class="form-control" type='hidden' name='MortgageInterestOnly' id='MortgageInterestOnly' readonly value='<?php echo $MortgageInterestOnly; ?>'></td>
                                 </tr>
                                 <tr>
                                    <td>Total Equilty Required</td>
                                    <td><span class='valhml11'><?php echo $TotalEquiltyRequiredVal; ?></span><input class="form-control" type='hidden' name='TotalEquiltyRequiredVal' id='TotalEquiltyRequiredVal' readonly value='<?php echo $TotalEquiltyRequiredVal; ?>'></td>
                                    <td>Projected monthly cash pos.</td>
                                    <td><span class='valhml12'><?php echo $Projectedmonthlycash; ?></span><input class="form-control" type='hidden' name='Projectedmonthlycash' id='Projectedmonthlycash'readonly  value='<?php echo $Projectedmonthlycash; ?>'></td>
                                 </tr>
                              </table>
                           </div>
                        </div>
                           ...
                           <div class="table-responsive">
                              <table class="table ">
                                 <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input class="form-control" type='text' name='EstGrsRentalIncome' id='EstGrsRentalIncome' value='<?php echo $EstGrsRentalIncome; ?>' readonly>
                                                <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">Per Unit</span>
                                              </div>
                                            </div>
                                    </td>
                                    <td style='display:none;'><input class="form-control" type='text' name='EstGrsRentalIncomeAmt' id='EstGrsRentalIncomeAmt' value='<?php echo $EstGrsRentalIncomeAmt; ?>'>&nbsp;&nbsp;</td>
                                    <td>&nbsp;</td>
                                 </tr>
                                 <tr>
                                    <td>Gross Yield</td>
                                    <td>
                                        <div class="input-group">
                                            <input class="form-control" type='text' name='GrossYield' id='GrossYield' value='<?php echo $GrossYield; ?>' readonly >
                                                <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">%</span>
                                              </div>
                                            </div>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input class="form-control" type='text' name='ServiceCharge' id='ServiceCharge' value='<?php echo $ServiceCharge; ?>' calc='EstimatedMonthlyIncome' >
                                                <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">psf</span>
                                              </div>
                                            </div>
                                    </td>
                                    <td><input class="form-control" type='text' name='ServiceChargeAmt' id='ServiceChargeAmt' readonly value='<?php echo $ServiceChargeAmt; ?>'>&nbsp;&nbsp;</td>
                                    <td style='display:none;'><input class="form-control" type='text' name='ServiceChargeSecAmt' id='ServiceChargeSecAmt' value='<?php echo $ServiceChargeSecAmt; ?>'>&nbsp;&nbsp;</td>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input class="form-control" type='text' name='TenantManagementFee' id='TenantManagementFee' value='<?php echo $TenantManagementFee; ?>' calc='EstimatedMonthlyIncome' >
                                                <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">of rental income (plus VAT)</span></span>
                                              </div>
                                            </div>
                                    </td>
                                    <td><input class="form-control" type='text' name='TenantManagementFeeAmt' id='TenantManagementFeeAmt'readonly  value='<?php echo $TenantManagementFeeAmt; ?>'>&nbsp;&nbsp;
                                            <input type='hidden' name='vatpercentage' id='vatpercentage' value='<?php echo $vatpercentage; ?>' ></td>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input class="form-control" type='text' name='GroundRent' id='GroundRent' value='<?php echo $GroundRent; ?>' readonly>
                                            <div class="input-group-append">
                                    ...
                                    <td><input class="form-control" type='text' name='GroundRentAmt' readonly id='GroundRentAmt' value='<?php echo $GroundRentAmt; ?>' calc='EstimatedMonthlyIncome' >&nbsp;&nbsp;</td>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input class="form-control" type='text' name='NetMonthlyExpenses' id='NetMonthlyExpenses' readonly value='<?php echo $NetMonthlyExpenses; ?>' readonly  >
                                            <div class="input-group-append">
                                          </div>
                                        </div>
                                  ...
                                  <tr>
                                    <td>ii Monthly Income</td>
                                    <td>
                                        <div class="input-group">
                                            <input class="form-control" type='text' name='ScndMonthlyExpenses' id='ScndMonthlyExpenses' readonly value='<?php echo $ScndMonthlyExpenses; ?>' readonly >
                                            <div class="input-group-append">
                                          </div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input class="form-control" type='text' name='NetYeild' id='NetYeild' value='<?php echo $NetYeild; ?>' readonly >
                                            <div class="input-group-append">
                                          </div>
                                        </div>
                                  ...
                                  <tr>
                                    <td>Mortgage type Interset Only</td>
                                    <td>
                                        <div class="input-group">
                                            <input class="form-control" type='text' name='MortgageTypeIntersetOnly' id='MortgageTypeIntersetOnly' value='<?php echo $MortgageTypeIntersetOnly; ?>' readonly >
                                            <div class="input-group-append">
                                          </div>
                                        </div>
                                 ...
                                 <tr>
                                    <td>iii Projected Net Monthly Cash Position in Year 1</td>
                                    <td>
                                        <div class="input-group">
                                            <input class="form-control" type='text' name='ProjNetMonthPostion' id='ProjNetMonthPostion' value='<?php echo $ProjNetMonthPostion; ?>' readonly >
                                            <div class="input-group-append">
                                          </div>
                                        </div>
    ...
    $(document).ready(function(){
       ...
       $(document).delegate('#left', 'click', function () {
        ...
        $(document).on("blur", "#Purchaseprice", function(){
            //console.log("in");
            CalcInitialCostFn();
            CalcFinalcostcompletionFn();
            CalcEstimatedMonthlyIncomeFn();
        });
        
        $(document).on("blur", "[calc='InitialCosts']", function(){
            //console.log("in");
            CalcInitialCostFn();
        });
        
        
         $(document).on("blur", "[calc='Finalcostcompletion']", function(){
            //console.log("in");
            CalcFinalcostcompletionFn();
        });
        
        
        $(document).on("blur", "[calc='EstimatedMonthlyIncome']", function(){
            //console.log("in");
            CalcEstimatedMonthlyIncomeFn();
        });
        
        
         $(document).on("blur", "[calc='UnitSize']", function(){
            //console.log("in");
            CalcEstimatedMonthlyIncomeFn();
        });

        
         $(document).on("change", "#MortgageType,#MortgageLendingVal", function(){
            //console.log("in");
            //alert("hii");
            CalcFinalcostcompletionFn();
        });
         ...
         var CalcInitialCostFn = function(){
        
            //CurVal = e.value; 
            Purchaseprice               = FnNulltoAmt( $("#Purchaseprice").val());
            ipglbclientfee               = FnNulltoAmt( $("#ipglbclientfee").val());
            ReservationDeposit          = FnNulltoAmt( $("#ReservationDeposit").val() );
            Conveyancingfees            = FnNulltoAmt( $("#Conveyancingfees").val() );
            Landregistryfees            = FnNulltoAmt( $("#Landregistryfees").val() );
            Engrossmentfees             = FnNulltoAmt( $("#Engrossmentfees").val() );
            
            //console.log('ipglbclientfee='+ ipglbclientfee);
            
            ipglbclientfeeAmt           = - parseFloat(ipglbclientfee);
            
            ResDepositPercntage         =   parseFloat(ReservationDeposit) / 100;
            ReservationDepositAmt       =   -(parseFloat(Purchaseprice) *   parseFloat(ResDepositPercntage));
            
            ConveyancingfeesAmt         = - parseFloat(Conveyancingfees);
            
            LandregistryfeesAmt         = - parseFloat(Landregistryfees);
            
            EngrossmentfeesAmt          = - parseFloat(Engrossmentfees);
            
            PaymentResExcAmount         =  parseFloat(ipglbclientfeeAmt) +  parseFloat(ReservationDepositAmt) + parseFloat(ConveyancingfeesAmt) + parseFloat(LandregistryfeesAmt) + parseFloat(EngrossmentfeesAmt);
            
            
             $("#ipglbclientfeeAmt").val(Math.round(ipglbclientfeeAmt));
             $("#ReservationDepositAmt").val(Math.round(ReservationDepositAmt));
             $("#ConveyancingfeesAmt").val(Math.round(ConveyancingfeesAmt));
             $("#LandregistryfeesAmt").val(Math.round(LandregistryfeesAmt));
             $("#EngrossmentfeesAmt").val(Math.round(EngrossmentfeesAmt));
             $("#PaymentResExcAmount").val(Math.round(PaymentResExcAmount));
             $(".valhml1").html(Math.round(PaymentResExcAmount));
        ...
        var CalcFinalcostcompletionFn = function(){
            
                Purchaseprice               = FnNulltoAmt( $("#Purchaseprice").val());
                Finalcapitalpayment         = FnNulltoAmt( $("#Finalcapitalpayment").val());
                Stampduty                   = FnNulltoAmt( $("#Stampduty").val() );
                LiquidExpatbrokercosts      = FnNulltoAmt( $("#LiquidExpatbrokercosts").val() );
                Lenderarrangementfee        = FnNulltoAmt( $("#Lenderarrangementfee").val() );
                Valuationfee                = FnNulltoAmt( $("#Valuationfee").val() );
                Furniturepack               = FnNulltoAmt( $("#Furniturepack").val());
                CompleteTenantfee          = FnNulltoAmt( $("#CompleteTenantfee").val());
                CompleteTenantagreementfee  = FnNulltoAmt( $("#CompleteTenantagreementfee").val() );
                CompleteHandoverfee         = FnNulltoAmt( $("#CompleteHandoverfee").val() );
                CompleteInventoryfee        = FnNulltoAmt( $("#CompleteInventoryfee").val() );
                CompleteReferenceCheck      = FnNulltoAmt( $("#CompleteReferenceCheck").val() );
                ClientFeeRebateComp         = FnNulltoAmt( $("#ClientFeeRebateComp").val() );
                
               
                PaymentResExcAmount         = FnNulltoAmt( $("#PaymentResExcAmount").val() );
                MortgageType                = $("#MortgageType").val() ;
                MortgageLendingVal          = FnNulltoAmt( $("#MortgageLendingVal").val() );
                
                
                
                
                FinalcapitalpaymentAmt             =  - (parseFloat(Purchaseprice) * parseFloat(Finalcapitalpayment)  / 100 );
                StampdutyAmt                       =  - parseFloat(Stampduty)  ;
                LiquidExpatbrokercostsAmt          =  - parseFloat(LiquidExpatbrokercosts)  ;
                LenderarrangementfeeAmt            =  - parseFloat(Lenderarrangementfee)  ;
                ValuationfeeAmt                    =  - parseFloat(Valuationfee)  ;
                FurniturepackAmt                   =  - parseFloat(Furniturepack)  ;
                CompleteTenantfeeAmt               =  - parseFloat(CompleteTenantfee)  ;
                CompleteTenantagreementfeeAmt      =  - parseFloat(CompleteTenantagreementfee)  ;
                CompleteHandoverfeeAmt             =  - parseFloat(CompleteHandoverfee)  ;
                CompleteInventoryfeeAmt            =  - parseFloat(CompleteInventoryfee)  ;
                CompleteReferenceCheckAmt          =  - parseFloat(CompleteReferenceCheck)  ;
                ClientFeeRebateCompAmt             =    parseFloat(ClientFeeRebateComp)  ;
                
                
               
                
                
                PaymentOnCompleteion               =   parseFloat(FinalcapitalpaymentAmt) + parseFloat(StampdutyAmt) + parseFloat(LiquidExpatbrokercostsAmt) + parseFloat(LenderarrangementfeeAmt) + parseFloat(ValuationfeeAmt)
                                            + parseFloat(FurniturepackAmt) + parseFloat(CompleteTenantfeeAmt) + parseFloat(CompleteTenantagreementfeeAmt) + parseFloat(CompleteHandoverfeeAmt) + parseFloat(CompleteInventoryfeeAmt)
                                            + parseFloat(CompleteReferenceCheckAmt) + parseFloat(ClientFeeRebateCompAmt);
                                            
                FurtherDepositAmt                   =     parseFloat(Purchaseprice)   * 0    
                                            
                TotalEquityRequired                 =   parseFloat(PaymentResExcAmount) + parseFloat(PaymentOnCompleteion) + parseFloat(FurtherDepositAmt);
                                            
                                            
                                            
                $("#FinalcapitalpaymentAmt").val(Math.round(FinalcapitalpaymentAmt));
                $("#StampdutyAmt").val(Math.round(StampdutyAmt));
                $("#LiquidExpatbrokercostsAmt").val(Math.round(LiquidExpatbrokercostsAmt));
                $("#LenderarrangementfeeAmt").val(Math.round(LenderarrangementfeeAmt));
                $("#ValuationfeeAmt").val(Math.round(ValuationfeeAmt));
                $("#FurniturepackAmt").val(Math.round(FurniturepackAmt));
                $("#CompleteTenantfeeAmt").val(Math.round(CompleteTenantfeeAmt));
                $("#CompleteTenantagreementfeeAmt").val(Math.round(CompleteTenantagreementfeeAmt));
                $("#CompleteHandoverfeeAmt").val(Math.round(CompleteHandoverfeeAmt));
                $("#CompleteInventoryfeeAmt").val(Math.round(CompleteInventoryfeeAmt));
                $("#CompleteReferenceCheckAmt").val(Math.round(CompleteReferenceCheckAmt));
                $("#ClientFeeRebateCompAmt").val(Math.round(ClientFeeRebateCompAmt));
                
                $("#PaymentOnCompleteion").val(Math.round(PaymentOnCompleteion));
                $(".valhml2").html(Math.round(PaymentOnCompleteion));
                
                $("#TotalEquityRequired").val(TotalEquityRequired);
                $(".valhml3").html(Math.round(TotalEquityRequired));
                
                
                //console.log('MortgageType='+ MortgageType);
                if ( MortgageType != "None"){
        
                    MortgageLendingValPercentage        =    parseFloat(MortgageLendingVal) / 100;
                    TotalMortgageAmount                 =    parseFloat(Purchaseprice) *  parseFloat(MortgageLendingValPercentage);
                ...
                $("#TotalMortgageAmount").val(Math.round(TotalMortgageAmount));
                $(".valhml4").html(Math.round(TotalMortgageAmount));
        ...
        var CalcEstimatedMonthlyIncomeFn = function(){
            
            
                Purchaseprice               = FnNulltoAmt( $("#Purchaseprice").val());
                ServiceCharge               = FnNulltoAmt( $("#ServiceCharge").val());
                TenantManagementFee         = FnNulltoAmt( $("#TenantManagementFee").val());
                EstGrsRentalIncome          = FnNulltoAmt( $("#EstGrsRentalIncome").val());
                ...
                UnitSize                    = FnNulltoAmt( $("#UnitSize").val());
                vatpercentage               = FnNulltoAmt( $("#vatpercentage").val());
                
                
                GrossYieldTemp                        =  (parseFloat(EstGrsRentalIncome) * 12) / parseFloat(Purchaseprice);
                GrossYield                            =  parseFloat(parseFloat(GrossYieldTemp)  * 100).toFixed(1);
                
    
                ServiceChargeAmt                       = - ( parseFloat(ServiceCharge) * parseFloat(UnitSize)  / 12 );

                vatpercentageTemp                      =  parseFloat(vatpercentage) / 100;
                TenantManagementFeeAmt                 =  -  parseFloat( ( parseFloat(EstGrsRentalIncome) *  parseFloat(TenantManagementFee) / 100)  * (1 + parseFloat(vatpercentageTemp))).toFixed(2);
                
                
                //console.log('Purchaseprice='+ Purchaseprice);
                
                GroundRentTemp                         =  (parseFloat(Purchaseprice) * 0.1 / 12);
                GroundRent                             =  parseFloat(GroundRentTemp) / 100;
                
                GroundRentAmt                          =  - parseFloat(GroundRent); 
                
                
                NetMonthlyExpenses                     =   parseFloat(ServiceChargeAmt) +  parseFloat(TenantManagementFeeAmt) + parseFloat(GroundRentAmt);
                ScndMonthlyExpenses                    =   parseFloat(NetMonthlyExpenses) +  parseFloat(EstGrsRentalIncome);
               
                NetYeildTemp                           =   (parseFloat(ScndMonthlyExpenses) * 12) / parseFloat(Purchaseprice);  
                NetYeild                               =   parseFloat(parseFloat(NetYeildTemp) * 100).toFixed(1);
                ...
                ProjNetMonthPostion                    =  parseFloat(MortgageTypeIntersetOnly) + parseFloat(ScndMonthlyExpenses);
                
                 $("#GrossYield").val(GrossYield);
                 
                 $("#GroundRent").val(Math.round(GroundRent));
                 
                 
                 
                 
                 $("#ServiceChargeAmt").val(Math.round(ServiceChargeAmt));
                 $("#TenantManagementFeeAmt").val(Math.round(TenantManagementFeeAmt));
                 $("#GroundRentAmt").val(Math.round(GroundRentAmt));
                 
                 
                 $("#NetMonthlyExpenses").val(Math.round(NetMonthlyExpenses));
                 $("#ScndMonthlyExpenses").val(Math.round(ScndMonthlyExpenses));
                 $("#NetYeild").val(NetYeild);
                 $("#ProjNetMonthPostion").val(Math.round(ProjNetMonthPostion));
        ...
        var CalcSnapShotFn = function(){
            
            
                Paymentonreservation            = FnNulltoAmt( $("#PaymentResExcAmount").val());
                FurtherdepositTotal             = FnNulltoAmt( $("#FurtherDepositAmt").val());
                PaymentPropComp                 = FnNulltoAmt( $("#PaymentOnCompleteion").val());
                TotalEquiltyRequiredVal         = FnNulltoAmt( $("#TotalEquityRequired").val());
                MortgagePrincipleTotal           = FnNulltoAmt( $("#TotalMortgageAmount").val());
                Projectedmonthlycash            = FnNulltoAmt( $("#ProjNetMonthPostion").val());
                MortgageInterestOnly            = FnNulltoAmt( $("#MortgageTypeIntersetOnly").val());
                MonthlyIncome                   = FnNulltoAmt( $("#ScndMonthlyExpenses").val());
                

                
                $("#Paymentonreservation").val(Math.round(Paymentonreservation));
                $(".valhml5").html(Math.round(Paymentonreservation));
                
                $("#MortgagePrincipleTotal").val(Math.round(MortgagePrincipleTotal));
                $(".valhml6").html(Math.round(MortgagePrincipleTotal));
                
                $("#FurtherdepositTotal").val(Math.round(FurtherdepositTotal));
                $(".valhml7").html(Math.round(FurtherdepositTotal));
                
                $("#MonthlyIncome").val(Math.round(MonthlyIncome));
                $(".valhml8").html(Math.round(MonthlyIncome));
                
                $("#PaymentPropComp").val(Math.round(PaymentPropComp));
                $(".valhml9").html(Math.round(PaymentPropComp));
                
                $("#MortgageInterestOnly").val(Math.round(MortgageInterestOnly));
                $(".valhml10").html(Math.round(MortgageInterestOnly));
                
                $("#TotalEquiltyRequiredVal").val(Math.round(TotalEquiltyRequiredVal));
                $(".valhml11").html(Math.round(TotalEquiltyRequiredVal));
                
                $("#Projectedmonthlycash").val(Math.round(Projectedmonthlycash));
                $(".valhml12").html(Math.round(Projectedmonthlycash));
