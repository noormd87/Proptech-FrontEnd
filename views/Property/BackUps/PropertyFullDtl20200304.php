...
foreach ($rows as $row) 
{
	...
	$no_of_bedrooms						= isset($row["no_of_bedrooms"]) ? $row["no_of_bedrooms"] : "";
	...
	$loan_purchase_deposit   			= $row["loan_purchase_deposit"] ? $row["loan_purchase_deposit"] : "0";
	$loan_purchase_market_value   		= $row["loan_purchase_market_value"] ? $row["loan_purchase_market_value"] : "0";
	$loan_purchase_amount   			= $row["loan_purchase_amount"] ? $row["loan_purchase_amount"] : "0";
	...
	$arr_rental_type   					= $row["arr_rental_type"] ? $row["arr_rental_type"] : "0";
	...
	$ape_management_fees   				= $row["ape_management_fees"] ? $row["ape_management_fees"] : "0";
	...
	$mf_customer_price_index   			= $row["mf_customer_price_index"] ? $row["mf_customer_price_index"] : "0";
	$mf_capital_growth   				= $row["mf_capital_growth"] ? $row["mf_capital_growth"] : "0";
	...
	$loan_value_ratio_growth   			= $row["loan_value_ratio_growth"] ? $row["loan_value_ratio_growth"] : "0";
...
if ( $PrtyCnt  > 0 || $RecentAnalyse =="Y" )	
{
	...
	foreach ($GetDbVals as $GetDbVal) 
	{
		...
		$arr_rental_type   					= $GetDbVal["arr_rental_type"] ? $GetDbVal["arr_rental_type"] : "0" ;
		...
		$ape_management_fees   				= $GetDbVal["ape_management_fees"] ? $GetDbVal["ape_management_fees"] : "0" ;
		...
		$mf_customer_price_index   			= $GetDbVal["mf_customer_price_index"] ? $GetDbVal["mf_customer_price_index"] : "0" ;
		$mf_capital_growth   				= $GetDbVal["mf_capital_growth"] ? $GetDbVal["mf_capital_growth"] : "0" ;
		...
		$loan_value_ratio_growth   			= $GetDbVal["loan_value_ratio_growth"] ? $GetDbVal["loan_value_ratio_growth"] : "0" ;
	...
	if ( $property_master_auto_id != "" ){
		...
		foreach ($GetDbDtlVals as $GetDbDtlVal) 
		{
			...
			$loan_interset_rate   				= $GetDbDtlVal["loan_interset_rate"] ? $GetDbDtlVal["loan_interset_rate"] : "0";
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    //Market Value
	var mrktValValue = $('#mrktValRange');
    $("#loan_purchase_market_value").val($("#mrktValRange").val());
