            ...
            <div class="search-time-holder">
                ...
                <div class="time-slots">
                    <div class="d-inline-flex align-items-center">
                        <input class="custom-form-control datepicker" type="text" name="datefilter1" id="datefilter1" value="<?php echo $datefilter1; ?>" />
                    </div>
                    <div class="d-inline-flex align-items-center">
                        <input class="custom-form-control datepicker" type="text" name="datefilter2" id="datefilter2" value="<?php echo $datefilter2; ?>" />
                    </div>
                                ...
                                <div class="rd-content">
                                    ...
                                    <div class="place-type">
                                        ...
                                        <div class="build">
                                            ...
                                            <div>
                                                <input type="button" class="btn btn-default" onclick="BuildTypeFN()" value="Confirm" >
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Nav pills -->
                        ...
                        <div class="col-12">
                            ...
                            <div class="sr-panel">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-12" <?php echo $StyleHide; ?> >
                                        <div class="card">
                                          <div class="card-header">
                                            <h4 class="card-title">Education By Level</h4>
                                          </div>
            ...
            */
               ...
               //console.log('<?php echo SITE_BASE_URL;?>api/OverviewSalesRentAjax.html');
                ...
                success: function (data) {
                        ...
                        $(".scift").val(data.scift);
                        $(".PricePaid").val(data.PricePaid);
                        $(".PaidDiscount").val(data.PaidDiscount);
                        $(".GrossYield").val(data.GrossYield);
                        $(".SalesListing").val(data.SalesListing);
                        $(".SalesTransactions").val(data.SalesTransactions);
                        
                        $(".sciftBd1").val(data.sciftBd1);
                        $(".PricePaidBd1").val(data.PricePaidBd1);
                        $(".PaidDiscountBd1").val(data.PaidDiscountBd1);
                        $(".GrossYieldBd1").val(data.GrossYieldBd1);
                        $(".SalesListingBd1").val(data.SalesListingBd1);
                        $(".SalesTransactionsBd1").val(data.SalesTransactionsBd1);
                        
                        $(".sciftBd2").val(data.sciftBd2);
                        $(".PricePaidBd2").val(data.PricePaidBd2);
                        $(".PaidDiscountBd2").val(data.PaidDiscountBd2);
                        $(".GrossYieldBd2").val(data.GrossYieldBd2);
                        $(".SalesListingBd2").val(data.SalesListingBd2);
                        $(".SalesTransactionsBd2").val(data.SalesTransactionsBd2);
                        
                        
                        $(".sciftBd3").val(data.sciftBd3);
                        $(".PricePaidBd3").val(data.PricePaidBd3);
                        $(".PaidDiscountBd3").val(data.PaidDiscountBd3);
                        $(".GrossYieldBd3").val(data.GrossYieldBd3);
                        $(".SalesListingBd3").val(data.SalesListingBd3);
                        $(".SalesTransactionsBd3").val(data.SalesTransactionsBd3);
                        
                        $(".sqfiRent").val(data.sqfiRent);
                        $(".RentList").val(data.RentList);
                        
                        $(".sqfiRentBd1").val(data.sqfiRentBd1);
                        $(".RentListBd1").val(data.RentListBd1);
                        
                        
                        $(".sqfiRentBd2").val(data.sqfiRentBd2);
                        $(".RentListBd2").val(data.RentListBd2);
                        
                        $(".sqfiRentBd3").val(data.sqfiRentBd3);
                        $(".RentListBd3").val(data.RentListBd3);
