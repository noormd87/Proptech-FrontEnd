                    ...
                    <div class="card-body">
                             <div class="table-responsive quartiles">
                              ...
                              <table class="analysis-table table table-striped" align='center' >
                                    ...
                                    <tr>
                                        <td><?php echo number_format($TotalPopulation); ?></td>
                                        <td><?php echo round(floatval($TotMedianAgeVal) / $jNew); ?></td>
                                        <td><?php echo number_format($TotPopulationDensity); ?></td>
                                        <td><?php echo number_format($TotHigherEducationEQI); ?></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td><?php echo number_format($TotPopulationAgeLess20); ?></td>
                                        <td><?php echo number_format($TotPopulationAgeBet2024); ?></td>
                                        <td><?php echo number_format($TotPopulationAgeBet2529); ?></td>
                                        <td><?php echo number_format($TotPopulationAgeBet3034); ?></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td><?php echo number_format($TotPopulationAgeBet3539); ?></td>
                                        <td><?php echo number_format($TotPopulationAgeBet4044); ?></td>
                                        <td><?php echo number_format($TotPopulationAgeBet4549); ?></td>
                                        <td><?php echo number_format($TotPopulationAgeBet5054); ?></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td><?php echo number_format($TotPopulationAgeBet5559); ?></td>
                                        <td><?php echo number_format($TotPopulationAgeBet6064); ?></td>
                                        <td><?php echo number_format($TotPopulationAgeBet6569); ?></td>
                                        <td><?php echo number_format($TotPopulationAgeBet7074); ?></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td><?php echo number_format($TotPopulationAgeBet7579); ?></td>
                                        <td><?php echo number_format($TotPopulationAgeBet8084); ?></td>
                                        <td><?php echo number_format($TotPopulationAgeAbove85); ?></td>
                                        <td>&nbsp;</td>
                                    </tr>
