                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="filter-box-inner">
                                  <div class="row">
                                    <div class="form-group col-6">
                                      <input type="checkbox" name="datasource" value='Discnt' <?php if ($datasource == "Discnt" ) { ?> checked <?php }?> class="icheckRadio">
                                      <label>Discount</label>
                                    </div>
                                    <div class="form-group col-6">
                                      <input type="checkbox" name="datasource" value='GrsYld' <?php if ($datasource == "GrsYld" ) { ?> checked <?php }?> class="icheckRadio">
                                      <label>Gross Yield</label>
                                    </div>
                                    <div class="form-group col-6">
                                      <input type="checkbox" name="datasource" value='PriAsk' <?php if ($datasource == "PriAsk" ) { ?> checked <?php }?> class="icheckRadio">
                                      <label>Price Asked</label>
                                    </div>
                                    <div class="form-group col-6">
                                      <input type="checkbox" name="datasource" value='RentAsk' <?php if ($datasource == "RentAsk" ) { ?> checked <?php }?> class="icheckRadio">
                                      <label>Rent Asking</label>
                                    </div>
                                    <div class="form-group col-6">
                                      <input type="checkbox" name="datasource" value='sqfiRent'  <?php if ($datasource == "sqfiRent" ) { ?> checked <?php }?> class="icheckRadio">
                                      <label>$/sqfi - Rent</label>
                                    </div>
                                    <div class="form-group col-6">
                                      <input type="checkbox" name="datasource" value='sqfiSales' <?php if ($datasource == "sqfiSales" ) { ?> checked <?php }?>  class="icheckRadio">
                                      <label>$/sqfi - Sales</label>
                                    </div>
                                    <div class="form-group col-6">
                                      <input type="checkbox" name="datasource" value='PriPaid' <?php if ($datasource == "PriPaid" ) { ?> checked <?php }?> class="icheckRadio">
                              ...
                              <div class="tab-pane fade" id="pills-property" role="tabpanel" aria-labelledby="pills-property-tab">
                                <div class="filter-box-inner">
                                  <div class="row">
                                    <div class="form-group col-6">
                                      <input type="checkbox" name="datasource" value='DaysMarRent' <?php if ($datasource == "DaysMarRent" ) { ?> checked <?php }?>  class="icheckRadio">
                                      <label>Days on Market - Rent</label>
                                    </div>
                                    <div class="form-group col-6">
                                      <input type="checkbox" name="datasource" value='PropSize' <?php if ($datasource == "PropSize" ) { ?> checked <?php }?> class="icheckRadio">
                                      <label>Property Size</label>
                                    </div>
                                    <div class="form-group col-6">
                                      <input type="checkbox" name="datasource" value='DaysMarSales' <?php if ($datasource == "DaysMarSales" ) { ?> checked <?php }?>  class="icheckRadio">
                                      <label>Days on Market - Sales</label>
                                    </div>
                                    <div class="form-group col-6">
                                      <input type="checkbox" name="datasource" value='RentList' <?php if ($datasource == "RentList" ) { ?> checked <?php }?> class="icheckRadio">
                                      <label>Rent Listing</label>
                                    </div>
                                    <div class="form-group col-6">
                                      <input type="checkbox" name="datasource" value='NewRentList' <?php if ($datasource == "NewRentList" ) { ?> checked <?php }?> class="icheckRadio">
                                      <label>New Rent Listing</label>
                                    </div>
                                    <div class="form-group col-6">
                                      <input type="checkbox" name="datasource" value='SalesList' <?php if ($datasource == "SalesList" ) { ?> checked <?php }?> class="icheckRadio">
                                      <label>Sales Listing</label>
                                    </div>
                                    <div class="form-group col-6">
                                      <input type="checkbox" name="datasource" value='NewSalesList' <?php if ($datasource == "NewSalesList" ) { ?> checked <?php }?>   class="icheckRadio">
                                      <label>New Sales Listing</label>
                                    </div>
                                    <div class="form-group col-6">
                                      <input type="checkbox" name="datasource" value='SalesTrans' <?php if ($datasource == "SalesTrans" ) { ?> checked <?php }?>  class="icheckRadio">
...
new mapboxgl.Marker().setLngLat(feature.center).addTo(map);
    ...
    ?>
                            ...
                            <div class="table-wrapper">
                                <table class="table mb-0">
                                  ...
                                  <tbody>
                                    ...
                                    $HouseholdIncomeArr  =  \api\apiClass::HouseholdIncomeTableVal($LocationId,$StreetId,$ZipcodeId,$propertyTypeId); 
        ...
        <?php //include_once("corelogic-json-test.php"); 
            ...
            echo \api\apiClass::ShowMedianMapApi($LocationId,$StreetId,$ZipcodeId,$Subrub,"",$propertyTypeId); 
            ...
            echo \api\apiClass::RentalStatisticsApi($LocationId,$StreetId,$ZipcodeId,$Subrub,$propertyTypeId,$MetricsRentalStatics);
             echo \api\apiClass::RentalRateObservationApi($LocationId,$StreetId,$ZipcodeId,$Subrub,$propertyTypeId,$MetricsRentalRate);
            echo \api\apiClass::ChangerenatalRateApi($LocationId,$StreetId,$ZipcodeId,$Subrub,$propertyTypeId,$MetricsChangerenatalRate);
            echo \api\apiClass::GrossRentalYieldApi($LocationId,$StreetId,$ZipcodeId,$Subrub,$propertyTypeId,$MetricsGrossRentalYield);
                    ...
                    <div class="card-body">
                             <div class="table-responsive quartiles">
                              ...
                              <table class="table table-striped" align='center' >
                                    ...
                                    <tr>
                                        <td><?php echo floatval($TotalPopulation); ?></td>
                                        <td><?php echo round($TotMedianAgeVal/2); ?></td>
                                        <td><?php echo floatval($TotPopulationDensity); ?></td>
                                        <td><?php echo floatval($TotHigherEducationEQI); ?></td>
                                    </tr>
                                    
                                    <tr>
                                        <th colspan=4> Population 0 to 34</th>
                                    </tr>
                                    ...
                                    <tr>
                                        <td><?php echo floatval($TotPopulationAgeLess20); ?></td>
                                        <td><?php echo floatval($TotPopulationAgeBet2024); ?></td>
                                        <td><?php echo floatval($TotPopulationAgeBet2529); ?></td>
                                        <td><?php echo floatval($TotPopulationAgeBet3034); ?></td>
                                    </tr>
                                    
                                     <tr>
                                        <th colspan=4> Population 35 to 54</th>
                                    </tr>
                                    ...
                                    <tr>
                                        <td><?php echo floatval($TotPopulationAgeBet3539); ?></td>
                                        <td><?php echo floatval($TotPopulationAgeBet4044); ?></td>
                                        <td><?php echo floatval($TotPopulationAgeBet4549); ?></td>
                                        <td><?php echo floatval($TotPopulationAgeBet5054); ?></td>
                                    </tr>
                                    
                                    <tr>
                                        <th colspan=4> Population 55 to 74</th>
                                    </tr>
                                    ...
                                    <tr>
                                        <td><?php echo floatval($TotPopulationAgeBet5559); ?></td>
                                        <td><?php echo floatval($TotPopulationAgeBet6064); ?></td>
                                        <td><?php echo floatval($TotPopulationAgeBet6569); ?></td>
                                        <td><?php echo floatval($TotPopulationAgeBet7074); ?></td>
                                    </tr>
                                    
                                     <tr>
                                        <th colspan=4> Population 75 to 80+</th>
                                    </tr>
                                    ...
                                    <tr>
                                        <td><?php echo floatval($TotPopulationAgeBet7579); ?></td>
                                        <td><?php echo floatval($TotPopulationAgeBet8084); ?></td>
                                        <td><?php echo floatval($TotPopulationAgeAbove85); ?></td>
                                        <td>&nbsp;</td>
                                    </tr>
    ...
    <?php  
         echo \api\apiClass::ProductFeatureApiUk("formap",$LocationId,$DataSrc,$BuildType,$bedrooms,$propertyType,$datefilter1,$datefilter2,$m);
