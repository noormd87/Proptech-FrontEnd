                ...
                <div class="col-md-12">
                  <div class="form-group row">
                    ...
                    <div class="col-md-12 d-flex justify-content-between">
                      ...
                      <div class="form-check form-check-inline checkbox-one">
                        <input class="form-check-input" name="datasourceNew" value='DaysMarRent' <?php if ($datasource == "DaysMarRent" ) { ?> checked <?php }?>   type="checkbox" id="DaysMarRent" >
...
if( $IsALl == false )
{
         ...
         //echo $MultiPropertyValOther;
         
         echo 'MultiPropertyValOther='. $MultiPropertyValOther;
        ...
        foreach($DatasourceOtherArr as $DataSrc)
        {
                ...
                $IndexQry = "SELECT auto_id, api_id, api_name, display_name FROM api_common_details WHERE api_id = '{$DataSrc}' ";
        ...
        ?>
            ...
            <?php  
                 ...
                 echo \api\apiClass::FeatureCommonApiUkValue("formap",$LocationId,$DataSrc,$datefilter1,$datefilter2,$m,$ProductName);
            
                
                
                echo "<!-- Test  FeatureCommonApiUkValue or ProductFeatureApiUkDecimal = " . date("Y-m-d H:i:s") . "-->";
                ob_flush(); flush(); // send buffer output
                //exit;
