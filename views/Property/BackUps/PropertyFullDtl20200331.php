                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">  
                                       <div class="form-group">
                                          ...
                                          <input class="touchspin2" type="text" value="<?php echo $loan_purchase_market_value; ?>" name="loan_purchase_market_value" id="loan_purchase_market_value" calc="loan_purchase_cost">
                                          <div class="range-container">
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                       <div class="form-group">
                                          ...
                                          <input class="touchspin2" type="text" value="<?php echo $loan_purchase_amount; ?>" name="loan_purchase_amount" id="loan_purchase_amount" calc="loan_purchase_cost">
                                          <div class="range-container">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                       <div class="form-group">
                                          ...
                                          <input class="touchspin2" type="text" value="<?php echo $other_exp_capital; ?>" name="other_exp_capital" id="other_exp_capital" calc="loan_purchase_cost">
                                          <div class="range-container">
                                             <input type="range"min="0" max="1000000" step="1" value="<?php echo $other_exp_capital; ?>" id="other_exp_capitalRange" calc='loan_purchase_cost'>
                                          </div>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                       <div class="form-group">
                                          ...
                                          <input class="touchspin6" type="text" value="<?php echo $other_exp_slicitor_cost; ?>" name="other_exp_slicitor_cost" id="other_exp_slicitor_cost" calc="loan_purchase_cost">
                                          <div class="range-container">
                                             <input type="range" min="0" max="50000" step="1" value="<?php echo $other_exp_slicitor_cost; ?>" id="other_exp_slicitor_costRange" calc='loan_purchase_cost'>
                                          </div>
                                       </div> 
                                    </div>
                                    <!-- end solicitor cost-->
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                       <div class="form-group">
                                          <label>Other($) *</label>
                                          <input class="touchspin6" type="text" value="<?php echo $other_exp_other; ?>" name="other_exp_other" id="other_exp_other" calc="loan_purchase_cost">
                                          <div class="range-container">
                                             <input type="range" min="0" max="50000" step="1" value="<?php echo $other_exp_other; ?>" id="other_exp_otherRange" calc='loan_purchase_cost' >
                                          </div>
                                       </div>
                                    </div>
                                    <!-- end other-->
                                       ...
                                       <div class="" id="anaBody">
                                          <div class="row">
                                               <div class="col-4 mb-3">
                                                <input type="radio" <?php if($loan_pricipal_interest=="io"){?> Checked <?php }?>  value="io" name="loan_pricipal_interest" id="loan_interest"  calc="loan_purchase_cost" <?php echo $loanprincipalinterseteChecked; ?> > 
                                                 <label for="loan_interest">Interest Only</label>
                                              </div>
                                              <div class="col-6 mb-3">
                                                <input type="radio" <?php if($loan_pricipal_interest=="pi" || 1==1){?> Checked <?php }?>   value="pi" name="loan_pricipal_interest" id="loan_principal" calc="loan_purchase_cost"> 
                                          ...
                                          <div class="row">
                                             ...
                                             <div class="col-12 col-md-4 col-lg-4 col-xxl-4 range-form-group">
                                                <div class="form-group">
                                                   ...
                                                   <div class="row mb-4">
                                                      <div class="col-9">
                                                         <input class="touchspin1" type="text" value="<?php echo $loan_length_year; ?>" name="loan_length_year" id="loan_length_year" maxlength="3" calc="loan_purchase_cost"> 
                                                      </div>
                                                      <label class="col-form-label col-3">years &</label>
                                                   </div>
                                                   <div class="row">
                                                      <div class="col-9">
                                                         <input class="touchspin1" type="text" value="<?php echo $loan_length_month; ?>" name="loan_length_month" id="loan_length_month" maxlength="2" calc="loan_purchase_cost">
                                                      </div>
                                             ...
                                             <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                                <div class="form-group">
                                                   ...
                                                   <div class="range-container">
                                                      <input type="range" min="0" max="2000000" step="1" value="<?php echo $loan_amount_loan; ?>" id="loan_amount_loanRange">
                                                   </div>
                                                </div>
                                             </div>
                                             <!-- end amount of loan-->
                                             ...
                                             <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                                <div class="form-group">
                                                   ...
                                                   <input class="touchspin6" type="text" value="<?php echo $loan_esatblishment_fee; ?>" name="loan_esatblishment_fee" id="loan_esatblishment_fee" calc="loan_purchase_cost" >
                                                   <div class="range-container">
                                                      <input type="range" min="0" max="50000" step="1" value="<?php echo $loan_esatblishment_fee; ?>" id="loan_esatblishment_feeRange" calc="loan_purchase_cost" >
                                                   </div>
                                                </div>
                                             </div>
                                             ...
                                             <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                                <div class="form-group">
                                                   ...
                                                   <div class="range-container">
                                                      <input type="range" min="0" max="100" step="1" value="<?php echo $loan_interset_rate; ?>" id="loan_interset_rateRange" calc="loan_purchase_cost" >
                                                   </div>
                                                </div>
                                             </div>
                                             <!-- end intrerest rate-->
                                             ...
                                             <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                                <div class="form-group">
                                                   ...
                                                   <input class="touchspin6" type="text" value="<?php echo $loan_other_loan_costs; ?>" name="loan_other_loan_costs" id="loan_other_loan_costs" calc="loan_purchase_cost">
                                                   <div class="range-container">
                                                      <input type="range" min="0" max="50000" step="1" value="<?php echo $loan_other_loan_costs; ?>" id="loan_other_loan_costsRange" calc="loan_purchase_cost" >
                                                   </div>
                                                </div>
                                             </div>
                                             <!-- end other-->
                                             ...
                                             <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                                <div class="form-group">
                                                   ...
                                                   <input class="touchspin6" type="text" value="<?php echo $loan_valuation_fees; ?>" name="loan_valuation_fees" id="loan_valuation_fees" calc="loan_purchase_cost">
                                                   <div class="range-container">
                                                      <input type="range" min="0" max="50000" step="1" value="<?php echo $loan_valuation_fees; ?>" id="loan_valuation_feesRange" calc="loan_purchase_cost" >
                                                   </div>
                                                </div>
                                             </div>
                                             <!-- end other-->
                           ...
                           <div class="row">
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <div class="input-icon">
                                       <input class="touchspin10" type="text" value="<?php echo $arr_annual_rr; ?>" name="arr_annual_rr" id="arr_annual_rr">
                                    </div>
                                    <div class="range-container">
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin9" type="text" value="<?php echo $arr_weekly_rents; ?>" name="arr_weekly_rents" id="arr_weekly_rents" >
                                    <div class="range-container">
                                       <input type="range" min="0" max="2000" step="1" value="<?php echo $arr_weekly_rents; ?>" id="arr_weekly_rentsRange">
                                    </div>
                                 </div>
                              </div>
                              <!-- end market value-->
                        ...
                        <div class="card-body">
                           <div class="row">
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                 <div class="form-group">
                                    <label>Rates($) *</label>
                                    <input class="touchspin7" type="text" value="<?php echo $ape_rates; ?>" name="ape_rates" id="ape_rates" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="5000" step="1" value="<?php echo $ape_rates; ?>" id="ape_ratesRange"calc='AnnualPropertyExpense' >
                                    </div>
                                 </div>
                              </div>
                              <!-- end capital improvement-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin8" type="text" value="<?php echo $ape_body_corporate; ?>" name="ape_body_corporate" id="ape_body_corporate" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin6" type="text" value="<?php echo $ape_land_lease_fee; ?>" name="ape_land_lease_fee" id="ape_land_lease_fee" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="50000" step="1" value="<?php echo $ape_land_lease_fee; ?>" id="ape_land_lease_feeRange" calc='AnnualPropertyExpense' >
                                    </div>
                                 </div>
                              </div>
                              <!-- end stamping fee-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin4" type="text" value="<?php echo $ape_insurance; ?>" name="ape_insurance" id="ape_insurance" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range"min="0" max="1000" step="1" value="<?php echo $ape_insurance; ?>" id="ape_insuranceRange" calc='AnnualPropertyExpense'>
                                    </div>
                                 </div>
                              </div>
                              <!-- end other-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin11" type="text" value="<?php echo $ape_letting_fees; ?>" name="ape_letting_fees" id="ape_letting_fees" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="3000" step="1" value="<?php echo $ape_letting_fees; ?>" id="ape_letting_feesRange" calc='AnnualPropertyExpense' >
                                    </div>
                                 </div>
                              </div>
                              <!-- end Letting fees($)*-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin12" type="text" value="<?php echo $ape_management_fees; ?>" name="ape_management_fees" id="ape_management_fees" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="10" step="1" value="<?php echo $ape_management_fees; ?>" id="ape_management_feesRange" calc='AnnualPropertyExpense' >
                                    </div>
                                 </div>
                              </div>
                              <!-- end Management fees(%)*-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin4" type="text" value="<?php echo $ape_repairs_maitenance; ?>" name="ape_repairs_maitenance" id="ape_repairs_maitenance" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="1000" step="1" value="<?php echo $ape_repairs_maitenance; ?>" id="ape_repairs_maitenanceRange" calc='AnnualPropertyExpense' >
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin11" type="text" value="<?php echo $ape_gardening; ?>" name="ape_gardening" id="ape_gardening" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="3000" step="1" value="<?php echo $ape_gardening; ?>" id="ape_gardeningRange" calc='AnnualPropertyExpense' >
                                    </div>
                                 </div>
                              </div>
                              <!-- end Gardening($)*-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin4" type="text" value="<?php echo $ape_cleaning; ?>" name="ape_cleaning" id="ape_cleaning" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="1000" step="1" value="<?php echo $ape_cleaning; ?>" id="ape_cleaningRange" calc='AnnualPropertyExpense' >
                                    </div>
                                 </div>
                              </div>
                              <!-- end Cleaning($)*-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin4" type="text" value="<?php echo $ape_service_contract; ?>" name="ape_service_contract" id="ape_service_contract" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range"min="0" max="1000" step="1" value="<?php echo $ape_service_contract; ?>" id="ape_service_contractRange" calc='AnnualPropertyExpense' >
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    <label>Other($)*</label>
                                    <input class="touchspin7" type="text" value="<?php echo $ape_other; ?>" name="ape_other" id="ape_other" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="5000" step="1" value="<?php echo $ape_other; ?>" id="ape_otherRange" calc='AnnualPropertyExpense' >
                                    </div>
                                 </div>
                              </div>
                              <!-- end Other($)*-->
                           ...
                           <div class="row">
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <div class="range-container">
                                       <input type="range" min="0" max="100" step="1" value="<?php echo $ae_entity_rows; ?>" id="ae_entity_rowsRange">
                                    </div>
                                 </div>
                              </div>
                              <!-- end Entity rows-->
                              <!-- Entity Selected-->
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1" style='display:none;' >
                           ...
                           <div class="row">
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin12" type="text" value="<?php echo $mf_customer_price_index; ?>" name="mf_customer_price_index" id="mf_customer_price_index" >
                                    <div class="range-container">
                                       <input type="range" min="0" max="10" step="1" value="<?php echo $mf_customer_price_index; ?>" id="mf_customer_price_indexRange">
                                    </div>
                                 </div>
                              </div>
                              <!-- end Entity rows-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin12" type="text" value="<?php echo $mf_capital_growth; ?>" name="mf_capital_growth" id="mf_capital_growth" >
                                    <div class="range-container">
                                       <input type="range" min="0" max="10" step="1" value="<?php echo $mf_capital_growth; ?>" id="mf_capital_growthRange">
                                    </div>
                                 </div>
                              </div>
                              <!-- end Entity rows-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin2" type="text" value="<?php echo $mf_land_tax; ?>" name="mf_land_tax" id="mf_land_tax" >
                                    <div class="range-container">
                                       <input type="range" min="0" max="1000000" step="1" value="<?php echo $mf_land_tax; ?>" id="mf_land_taxRange">
                                    </div>
                                 </div>
                              </div>
                              <!-- end Land Tax-->
                           ...
                           <div class="row">
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <div class="range-container">
                                       <input type="range" min="1900" max="3000" step="1" value="<?php echo $de_construction_year_completed; ?>" id="de_construction_year_completedRange">
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="">
                                    <div class="form-group">
                                       ...
                                       <div class="select-group">
                                          <select class="select-css form-control"> 
                                             <option>None</option>
                                          </select>
                                       </div>
                                    </div>
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <div class="range-container">
                                       <input type="range" min="0" max="2000000" step="1" value="<?php echo $de_estimate_land_value; ?>" id="de_estimate_land_valueRange">
                                    </div>
                                 </div>
                              </div>
                              <!-- end Construction year-->
