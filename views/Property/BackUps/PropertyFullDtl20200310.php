Principal <?php include "header.php"; ?>
<!-- main content -->
<div class="content">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                       <div class="form-group">
                                          ...
                                          <input class="touchspin2" type="text" value="<?php echo $other_exp_slicitor_cost; ?>" name="other_exp_slicitor_cost" id="other_exp_slicitor_cost" calc="loan_purchase_cost">
                                          <div class="range-container">
                                             <input type="range" min="0" max="1000000" step="1" value="<?php echo $other_exp_slicitor_cost; ?>" id="other_exp_slicitor_costRange" calc='loan_purchase_cost'>
                                          </div>
                                       </div>
                                    </div>
                                    <!-- end solicitor cost-->
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                       <div class="form-group">
                                          <label>Other($) *</label>
                                          <input class="touchspin2" type="text" value="<?php echo $other_exp_other; ?>" name="other_exp_other" id="other_exp_other" calc="loan_purchase_cost">
                                          <div class="range-container">
                                             <input type="range" min="0" max="1000000" step="1" value="<?php echo $other_exp_other; ?>" id="other_exp_otherRange" calc='loan_purchase_cost' >
                                          </div>
                                       </div>
                                    </div>
                                    <!-- end other-->
                                          ...
                                          <div class="row">
                                             ...
                                             <div class="col-12 col-md-4 col-lg-4 col-xxl-4 range-form-group">
                                                <div class="form-group">
                                                   ...
                                                   <div class="row mb-4">
                                                      <div class="col-9">
                                                         <input class="touchspin4" type="text" value="<?php echo $loan_length_year; ?>" name="loan_length_year" id="loan_length_year" maxlength="3" calc="loan_purchase_cost"> 
                                                      </div>
                                             ...
                                             <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                                <div class="form-group">
                                                   ...
                                                   <input class="touchspin2" type="text" value="<?php echo $loan_amount_loan; ?>" name="loan_amount_loan" id="loan_amount_loan" >
                                                   <div class="range-container">
                                                      <input type="range" min="0" max="1000000" step="1" value="<?php echo $loan_amount_loan; ?>" id="loan_amount_loanRange">
                                                   </div>
                                                </div>
                                             </div>
                                             <!-- end amount of loan-->
                                             ...
                                             <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                                <div class="form-group">
                                                   ...
                                                   <input class="touchspin2" type="text" value="<?php echo $loan_esatblishment_fee; ?>" name="loan_esatblishment_fee" id="loan_esatblishment_fee" calc="loan_purchase_cost" >
                                                   <div class="range-container">
                                                      <input type="range" min="0" max="1000000" step="1" value="<?php echo $loan_esatblishment_fee; ?>" id="loan_esatblishment_feeRange" calc="loan_purchase_cost" >
                                                   </div>
                                                </div>
                                             </div>
                                             ...
                                             <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                                <div class="form-group">
                                                   ...
                                                   <input class="touchspin2" type="text" value="<?php echo $loan_other_loan_costs; ?>" name="loan_other_loan_costs" id="loan_other_loan_costs" calc="loan_purchase_cost">
                                                   <div class="range-container">
                                                      <input type="range" min="0" max="1000000" step="1" value="<?php echo $loan_other_loan_costs; ?>" id="loan_other_loan_costsRange" calc="loan_purchase_cost" >
                                                   </div>
                                                </div>
                                             </div>
                                             <!-- end other-->
                                             ...
                                             <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                                <div class="form-group">
                                                   ...
                                                   <input class="touchspin2" type="text" value="<?php echo $loan_valuation_fees; ?>" name="loan_valuation_fees" id="loan_valuation_fees" calc="loan_purchase_cost">
                                                   <div class="range-container">
                                                      <input type="range" min="0" max="1000000" step="1" value="<?php echo $loan_valuation_fees; ?>" id="loan_valuation_feesRange" calc="loan_purchase_cost" >
                                                   </div>
                                                </div>
                                             </div>
                                             <!-- end other-->
                           ...
                           <div class="row">
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin2" type="text" value="<?php echo $arr_weekly_rents; ?>" name="arr_weekly_rents" id="arr_weekly_rents" >
                                    <div class="range-container">
                                       <input type="range" min="0" max="1000000" step="1" value="<?php echo $arr_weekly_rents; ?>" id="arr_weekly_rentsRange">
                                    </div>
                                 </div>
                              </div>
                              <!-- end market value-->
                        ...
                        <div class="card-body">
                           <div class="row">
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                 <div class="form-group">
                                    <label>Rates($) *</label>
                                    <input class="touchspin2" type="text" value="<?php echo $ape_rates; ?>" name="ape_rates" id="ape_rates" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="1000000" step="1" value="<?php echo $ape_rates; ?>" id="ape_ratesRange"calc='AnnualPropertyExpense' >
                                    </div>
                                 </div>
                              </div>
                              <!-- end capital improvement-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin2" type="text" value="<?php echo $ape_body_corporate; ?>" name="ape_body_corporate" id="ape_body_corporate" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="1000000" step="1" value="<?php echo $ape_body_corporate; ?>" id="ape_body_corporateRange" calc='AnnualPropertyExpense' >
                                    </div>
                                 </div>
                              </div>
                              <!-- end solicitor cost-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin2" type="text" value="<?php echo $ape_land_lease_fee; ?>" name="ape_land_lease_fee" id="ape_land_lease_fee" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="1000000" step="1" value="<?php echo $ape_land_lease_fee; ?>" id="ape_land_lease_feeRange" calc='AnnualPropertyExpense' >
                                    </div>
                                 </div>
                              </div>
                              <!-- end stamping fee-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin2" type="text" value="<?php echo $ape_insurance; ?>" name="ape_insurance" id="ape_insurance" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range"min="0" max="1000000" step="1" value="<?php echo $ape_insurance; ?>" id="ape_insuranceRange" calc='AnnualPropertyExpense'>
                                    </div>
                                 </div>
                              </div>
                              <!-- end other-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin2" type="text" value="<?php echo $ape_letting_fees; ?>" name="ape_letting_fees" id="ape_letting_fees" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="1000000" step="1" value="<?php echo $ape_letting_fees; ?>" id="ape_letting_feesRange" calc='AnnualPropertyExpense' >
                                    </div>
                                 </div>
                              </div>
                              <!-- end Letting fees($)*-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <div class="range-container">
                                       <input type="range" min="0" max="1000000" step="1" value="<?php echo $ape_management_fees; ?>" id="ape_management_feesRange" calc='AnnualPropertyExpense' >
                                    </div>
                                 </div>
                              </div>
                              <!-- end Management fees(%)*-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin2" type="text" value="<?php echo $ape_repairs_maitenance; ?>" name="ape_repairs_maitenance" id="ape_repairs_maitenance" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="1000000" step="1" value="<?php echo $ape_repairs_maitenance; ?>" id="ape_repairs_maitenanceRange" calc='AnnualPropertyExpense' >
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin2" type="text" value="<?php echo $ape_gardening; ?>" name="ape_gardening" id="ape_gardening" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="1000000" step="1" value="<?php echo $ape_gardening; ?>" id="ape_gardeningRange" calc='AnnualPropertyExpense' >
                                    </div>
                                 </div>
                              </div>
                              <!-- end Gardening($)*-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin2" type="text" value="<?php echo $ape_cleaning; ?>" name="ape_cleaning" id="ape_cleaning" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="1000000" step="1" value="<?php echo $ape_cleaning; ?>" id="ape_cleaningRange" calc='AnnualPropertyExpense' >
                                    </div>
                                 </div>
                              </div>
                              <!-- end Cleaning($)*-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin2" type="text" value="<?php echo $ape_service_contract; ?>" name="ape_service_contract" id="ape_service_contract" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range"min="0" max="1000000" step="1" value="<?php echo $ape_service_contract; ?>" id="ape_service_contractRange" calc='AnnualPropertyExpense' >
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    <label>Other($)*</label>
                                    <input class="touchspin2" type="text" value="<?php echo $ape_other; ?>" name="ape_other" id="ape_other" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="1000000" step="1" value="<?php echo $ape_other; ?>" id="ape_otherRange" calc='AnnualPropertyExpense' >
                                    </div>
                                 </div>
                              </div>
                              <!-- end Other($)*-->
                           ...
                           <div class="row">
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin2" type="text" value="<?php echo $de_estimate_land_value; ?>" name="de_estimate_land_value" id="de_estimate_land_value" >
                                    <div class="range-container">
                                       <input type="range" min="0" max="1000000" step="1" value="<?php echo $de_estimate_land_value; ?>" id="de_estimate_land_valueRange">
                                    </div>
                                 </div>
                              </div>
                              <!-- end Construction year-->
...
//	var mrktValValue = $('#loan_purchase_market_valueRange');
   // $("#loan_purchase_market_value").val($("#loan_purchase_market_valueRange").val());
    ...
    //Purchase Amount
    //alert($("#loan_purchase_amount").val());
