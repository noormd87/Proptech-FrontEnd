...
$countryid          = $_REQUEST["myportfoliocountry"] ? $_REQUEST["myportfoliocountry"] : "";
    ...
    <form class="analysis-form" accept-charset="utf-8" action="<?php echo SITE_BASE_URL; ?>ajax/AnalyzerResult.html?dt=<?php echo date("YmdHis"); ?>&page=html" method="post" >
        ...
        <div class="investment-panels">
            <div class="text-panel">
                ...
                <p>Instructions: </p>
                <p><span>1.</span> What if I don’t know the information for a selected field? No problems simply leave the field blank and we will assume the cost is zero.</p> 
                <p><span>2.</span> What if a filed is green? This information is required or pre-populated based on information you have already entered</p>
            </div>
            ...
            <div class="fields-panel">
                ...
                <p>Enter the information below about the cost of the property you are buying. Where you have existing income in country you will need to enter this in order to accurately determine your specific income tax costs. If you are not buying a property via Du Val PropTech make the Du Val Dynamic Price™ and the Market Price the same.</p>
                <div class="row">
                    <?php
                    if($countryid == "1")
                    {
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                                <label for="DuvalDynamicPrice">Original Purchase Price ™ <?php //echo $CurrencySym; ?></label>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control MarketPrice" style="background: #d0f2cc;" type="text" name='MarketPrice' id='MarketPrice' rel='calculate' value='<?php echo $MarketPrice; ?>'>
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                                <label for="">Estimated Stamp Duty <?php //echo $CurrencySym; ?></label>
                                <input class="form-control StampDuty" style="background: #fff;" type="text" name='StampDuty'  id='StampDuty' rel='calculate' value='<?php echo number_format($StampDuty); ?>' >
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                                <label for="">Transfer Fees <?php //echo $CurrencySym; ?></label>
                                <input class="form-control TransferFees" style="background: #fff;" type="text" name='TransferFees' id='TransferFees' rel='calculate' value='<?php echo $TransferFees; ?>' >
                            </div>
                        </div>
                    ...
                    else if($countryid == "2")
                    {
                        ...
                        <div class="col-xl-3 col-lg-6">
                            <div class="form-group">
                                ...
                                <input class="form-control AUDynamicPrice" type="text" name='AUDynamicPrice' style="background: #d0f2cc;" id='AUDynamicPrice' rel='calculate' value='<?php echo $AUDynamicPrice; ?>'>
                         ...
                         <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                                <label for="">Market Price <?php //echo $CurrencySym; ?></label>
                                <input class="form-control MarketPrice" type="text" name='MarketPrice' style="background: #d0f2cc;" id='MarketPrice' rel='calculate' value='<?php echo $MarketPrice; ?>'>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                                <label for=""> Existing Gross Income <!-- (excluding this property) --> <?php //echo $CurrencySym; ?></label>
                                <input class="form-control Income" type="text" name='Income' id='Income' style="background: #d0f2cc;" rel='calculate' value='<?php echo $Income; ?>'>
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                                <label for="">Legal Fees <?php //echo $CurrencySym; ?></label>
                                <input class="form-control LegalFees" type="text" name='LegalFees' style="background: #d0f2cc;" id='LegalFees' rel='calculate' value='<?php echo $LegalFees; ?>'>
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-6"></div>
                        <div class="col-xl-3 col-md-6"></div>
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control MortgageRegistration" style="background: #fff;"  type="text" name='MortgageRegistration' id='MortgageRegistration' rel='calculate' value='<?php echo $MortgageRegistration; ?>' >
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                                <label for="">Land Transfer <?php //echo $CurrencySym; ?></label>
                                <input class="form-control LandTransfer" style="background: #fff;" type="text" name='LandTransfer' id='LandTransfer' rel='calculate' value='<?php echo $LandTransfer; ?>' >
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                    ...
                    else if ($countryid == "3")
                    {
                        ...
                        <div class="col-xl-3 col-md-6">
                            ...
                            <div class="form-group SecondHomeInvestment" style="display:none">
                                <label for="">Original Purchase Price ™ <?php //echo $CurrencySym; ?></label>
                                <input class="form-control" type="text" style="background: #d0f2cc;" name='SecondHomeInvestment' id='SecondHomeInvestment' rel='calculate' value='<?php echo $SecondHomeInvestment; ?>'>
                            ...
                            <div class="form-group NonResidentInvestorAmt" style="display:none;">
                                <label for="">Original Purchase Price ™ <?php //echo $CurrencySym; ?></label>
                                <input class="form-control" type="text" style="background: #d0f2cc;" name='NonResidentInvestorAmt' id='NonResidentInvestorAmt' rel='calculate' value='<?php echo $NonResidentInvestorAmt; ?>'>
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                                <label for="">Market Price <?php //echo $CurrencySym; ?></label>
                                <input class="form-control MarketPrice" type="text" style="background: #d0f2cc;" name='MarketPrice' id='MarketPrice' rel='calculate' value='<?php echo $MarketPrice; ?>'>
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                                <label for=""> Existing Gross Income <!-- (excluding this property) --> <?php //echo $CurrencySym; ?></label>
                                <input class="form-control Income" type="text" name='Income' style="background: #d0f2cc;" id='Income' rel='calculate' value='<?php echo $Income; ?>'>
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                                <label for="">Legal Fees <?php //echo $CurrencySym; ?></label>
                                <input class="form-control LegalFees" type="text" style="background: #d0f2cc;" name='LegalFees' id='LegalFees' rel='calculate' value='<?php echo $LegalFees; ?>'>
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control LeaseRegistration"  type="text" name='LeaseRegistration' id='LeaseRegistration' rel='calculate' value='<?php echo $LeaseRegistration; ?>' >
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group">
                                <label for="">Total Purchase Cost <?php //echo $CurrencySym; ?></label>
                                <input class="form-control TotalPurchaseCost"  type="text" name='TotalPurchaseCost' id='TotalPurchaseCost' rel='calculate' value='<?php echo $TotalPurchaseCost; ?>' readonly>
                            </div>
                        </div>
                    ...
                    else
                    {
                        ...
                        if ($IsAuGbNz)
                        {
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group">
                                    <label for="">Market Price <?php //echo $CurrencySym; ?></label>
                                    <input class="form-control MarketPrice" type="text" name='MarketPrice' id='MarketPrice' rel='calculate' value='<?php echo $MarketPrice; ?>'>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group">
                                    <label for="DuvalDynamicPrice">DuVal Dynamic Price ™ <?php //echo $CurrencySym; ?></label>
                                    <input class="form-control DuvalDynamicPrice" type="text" <?php echo $ColorChange; ?> name='DuvalDynamicPrice' id='DuvalDynamicPrice' rel='calculate' value='<?php echo $DuvalDynamicPrice; ?>' <?php echo $DuvalPriceReadOnly; ?>>
                                </div>
                            </div>
                            <?php 
                        }
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6" style='display:none;'>
                        <div class="form-group">
                            ...
                            <input class="form-control ResetrvationFees" type="text" name='ResetrvationFees' id='ResetrvationFees' rel='calculate' value='<?php echo $ResetrvationFees; ?>'>
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6" >
                        <div class="form-group">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control StagePay1Amt" type="text" style="background: #fff;"  name='StagePay1Amt' id='StagePay1Amt' readonly  rel='calculate' value='<?php echo $StagePay1Amt; ?>'>
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6">
                        <div class="form-group">
                            <label for="">Stage Payment 2 <?php //echo $CurrencySym; ?></label>
                             <input class="form-control StagePay2Amt" type="text" style="background: #fff;" name='StagePay2Amt' id='StagePay2Amt' readonly  rel='calculate' value='<?php echo $StagePay2Amt; ?>'>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control Topup" type="text" style="background: #fff;"  name='Topup' id='Topup' rel='calculate' value='<?php echo $Topup; ?>' <?php echo $TopUpReadonly; ?> > 
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="fields-panel">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="form-group">
                            <label for="">Council Rates <?php //echo $CurrencySym; ?></label>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="form-group">
                            ...
                            {
                            ?>
                            <label for="">Body Corporate <?php// echo $CurrencySym; ?></label>
                            <?php
                            }
                            else if ($countryid == "3")
                            {
                            ?>
                            <label for=""> Service Charge <?php //echo $CurrencySym; ?></label>
                            <?php
                            }
                            else
                            {
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="form-group">
                            <label for=""> Land Lease <?php //echo $CurrencySym; ?></label>
                            <input class="form-control LandLeaseRentPa" type="text" style="background: #d0f2cc;" name='LandLeaseRentPa' id='LandLeaseRentPa' rel='calculate' value='<?php echo $LandLeaseRentPa; ?>'>
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6">
                        <div class="form-group">
                            <label for="">Insurance <?php// echo $CurrencySym; ?></label>
                            <input class="form-control InsurancePa" type="text" style="background: #d0f2cc;" name='InsurancePa' id='InsurancePa' rel='calculate' value='<?php echo $InsurancePa; ?>'>
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="form-group">
                            <label for="">Cleaning <?php //echo $CurrencySym; ?></label>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="form-group">
                            <label for="">Gardening <?php// echo $CurrencySym; ?></label>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="form-group">
                            <label for="">Service Contract <?php //echo $CurrencySym; ?></label>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="form-group">
                            <label for="">Other <?php //echo $CurrencySym; ?></label>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" style="background: #d0f2cc;" type="text" name='TermYears' id='TermYears' rel='calculate' value='<?php echo $TermYears; ?>'>
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6">
                        <div class="form-group">
