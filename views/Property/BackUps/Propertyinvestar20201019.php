            ...
            <div class="search-time-holder">
                ...
                <div class="time-slots date-drops">
                    <div class="group-drops">
                        <!-- Commented these bcz he asked the placeholder from and to for instead of default values -->
                        <!--<input class="form-control datepicker" type="text" name="datefilter1" id="datefilter1" value="<?php echo $datefilter1; ?>" placeholder="from"/>-->
                        <!--<input class="form-control datepicker" type="text" name="datefilter2" id="datefilter2" value="<?php echo $datefilter2; ?>" placeholder="to" />-->
