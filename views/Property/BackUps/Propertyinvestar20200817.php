                            ...
                            <div class="tab-content" id="pills-tabContent">
                              ...
                              <div class="tab-pane fade" id="pills-property" role="tabpanel" aria-labelledby="pills-property-tab">
                                <div class="filter-box-inner">
                                  <div class="row">
                                    <div class="form-group col-6">
                                      <input type="checkbox" name="datasource" value='DaysMarRent' <?php if ($datasource == "DaysMarRent" ) { ?> checked <?php }?> checked class="icheckRadio">
                                      <label>Days on Market - Rent</label>
                                    </div>
                                    <div class="form-group col-6">
                                      <input type="checkbox" name="datasource" value='PropSize' <?php if ($datasource == "PropSize" ) { ?> checked <?php }?> checked class="icheckRadio">
                                      <label>Property Size</label>
                                    </div>
                                    <div class="form-group col-6">
                                      <input type="checkbox" name="datasource" value='DaysMarSales' <?php if ($datasource == "DaysMarSales" ) { ?> checked <?php }?> checked class="icheckRadio">
                                      <label>Days on Market - Sales</label>
                                    </div>
                                    <div class="form-group col-6">
                                      <input type="checkbox" name="datasource" value='RentList' <?php if ($datasource == "RentList" ) { ?> checked <?php }?> checked class="icheckRadio">
                                      <label>Rent Listing</label>
                                    </div>
                                    <div class="form-group col-6">
                                      <input type="checkbox" name="datasource" value='NewRentList' <?php if ($datasource == "NewRentList" ) { ?> checked <?php }?> checked class="icheckRadio">
                                      <label>New Rent Listing</label>
                                    </div>
                                    <div class="form-group col-6">
                                      <input type="checkbox" name="datasource" value='SalesList' <?php if ($datasource == "SalesList" ) { ?> checked <?php }?> checked class="icheckRadio">
                                      <label>Sales Listing</label>
                                    </div>
                                    <div class="form-group col-6">
                                      <input type="checkbox" name="datasource" value='NewSalesList' <?php if ($datasource == "NewSalesList" ) { ?> checked <?php }?> checked  class="icheckRadio">
                                      <label>New Sales Listing</label>
                                    </div>
                                    <div class="form-group col-6">
                                      <input type="checkbox" name="datasource" value='SalesTrans' <?php if ($datasource == "SalesTrans" ) { ?> checked <?php }?> checked class="icheckRadio">
