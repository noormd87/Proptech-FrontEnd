...
$action    =  "Edit";
	...
	$property_master_auto_id   			= isset($_REQUEST["property_master_auto_id"]) ? $_REQUEST["property_master_auto_id"] : "";
...
foreach ($rows as $row) 
{
	...
	$property_purchase_value_price   	= $row["property_purchase_value_price"];
	$loan_purchase_deposit   			= $row["loan_purchase_deposit"];
	$loan_purchase_market_value   		= $row["loan_purchase_market_value"];
	$loan_purchase_amount   			= $row["loan_purchase_amount"] ;
	$other_exp_capital   				= $row["other_exp_capital"];
	$other_exp_slicitor_cost   			= $row["other_exp_slicitor_cost"];
	$other_exp_stamping_cost   			= $row["other_exp_stamping_cost"];
	$other_exp_other   					= $row["other_exp_other"];
	$arr_rental_type   					= $row["arr_rental_type"];
	$arr_annual_rr   					= $row["arr_annual_rr"];
	$arr_weekly_rents   				= $row["arr_weekly_rents"] ;
	$arr_total_annual_rent   			= $row["arr_total_annual_rent"];
	$ape_pricipal_interest   			= $row["ape_pricipal_interest"];
	$ape_rates   						= $row["ape_rates"];
	$ape_body_corporate   				= $row["ape_body_corporate"];
	$ape_land_lease_fee   				= $row["ape_land_lease_fee"];
	$ape_insurance   					= $row["ape_insurance"];
	$ape_letting_fees   				= $row["ape_letting_fees"];
	$ape_management_fees   				= $row["ape_management_fees"];
	$ape_repairs_maitenance   			= $row["ape_repairs_maitenance"];
	$ape_gardening   					= $row["ape_gardening"];
	$ape_service_contract   			= $row["ape_service_contract"];
	$ape_other   						= $row["ape_other"];
	$ae_property_belong   				= $row["ae_property_belong"];
	$ae_entity_rows   					= $row["ae_entity_rows"];
	$mf_customer_price_index   			= $row["mf_customer_price_index"];
	$mf_capital_growth   				= $row["mf_capital_growth"];
	$mf_land_tax  						= $row["mf_land_tax"];
	$de_calculate_depreciation   		= $row["de_calculate_depreciation"];
	$de_construction_year_completed   	= $row["de_construction_year_completed"];
	$de_recent_renovations   			= $row["de_recent_renovations"];
	$de_estimate_land_value   			= $row["de_estimate_land_value"];
	$loan_value_ratio_growth   			= $row["loan_value_ratio_growth"];
         ...
         <div class="row">
            ...
            <div class="col-9">
               <div class="title-area">
                  <h2 class="heading-primary"><?php echo $row["apartment_no"]; ?>|<?php echo $row["building"]; ?>|<?php echo $row["project_name"]; ?> | <?php echo $row["country"]; ?></h2>
               </div>
               <div class="row">
                              ...
                              <div class="card-body">
                                 <div class="row no-gutters">
                                    ...
                                    <div class="col-5 facility-right-col parking-bg">
                                       <div class="facility-quantity"><?php echo $no_of_parkingspace; ?></div>
                                    </div>
                                 </div>
                              </div>
                           </div>
                              ...
                              <div class="card-body">
                                 <div class="row no-gutters">
                                    ...
                                    <div class="col-5 facility-right-col room-bg">
                                       <div class="facility-quantity"><?php echo $no_of_bedrooms; ?></div>
                                    </div>
                                 </div>
                              </div>
                           </div>
                              ...
                              <div class="card-body">
                                 <div class="row no-gutters">
                                    ...
                                    <div class="col-5 facility-right-col bathroom-bg">
                                       <div class="facility-quantity"><?php echo $no_of_bathroom; ?></div>
                                    </div>
                                 </div>
                              </div>
                           </div>
                              ...
                              <div class="card-body">
                                 <div class="row">
                                    <div class="col-4 mb-3">
                                       <div class="i-checks ">
                                          <label class="PropertyPurhaseValDiv"><input type="radio" <?php if($property_purchase_value_price=="rateamount"){?> Checked <?php }?> value="rateamount" name="property_purchase_value_price" id="property_purchase_value_price" onclick="OnClickRadio(this);" > Enter as $ value</label>
                                       </div>
                                    </div>
                                    <div class="col-6 mb-3">
                                       <div class="i-checks ">
                                          <label class="PropertyPurhaseValDiv"><input type="radio" <?php if($property_purchase_value_price=="ratepercentage"){?> Checked <?php }?>  value="ratepercentage" name="property_purchase_value_price" id="property_purchase_value_percent"  onclick="OnClickRadio(this);" > Enter as % of property purchase price</label>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="row">
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon">
                                             <input class="touchspin3" type="text" value="<?php echo $loan_purchase_deposit; ?>"  name="loan_purchase_deposit" id="loan_purchase_deposit" calc="loan_purchase_cost">
                                             
                                             <input type="hidden" name="LoanPurchaseDepositTemp" id="LoanPurchaseDepositTemp" value=""  min="5" />
                                          </div>
                                          <div class="range-container">
                                             <input type="range" min="0" max="100" step="1" value="<?php echo $loan_purchase_deposit; ?>" id="loan_purchase_depositRange">
                                          </div>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                       <div class="form-group">
                                          ...
                                          <input class="touchspin3" type="text" value="<?php echo $loan_purchase_market_value; ?>" name="loan_purchase_market_value" id="loan_purchase_market_value" calc="loan_purchase_cost">
                                          <div class="range-container">
                                             <input type="range" min="0" max="100000" step="1" value="<?php echo $loan_purchase_market_value; ?>" id="loan_purchase_market_valueRange">
                                          </div>
                                       </div>
                                    </div>
                                    <!-- end market value-->
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                       <div class="form-group">
                                          ...
                                          <input class="touchspin3" type="text" value="<?php echo $loan_purchase_amount; ?>" name="loan_purchase_amount" id="loan_purchase_amount" calc="loan_purchase_cost">
                                          <div class="range-container">
                                             <input type="range" min="0" max="1000000" step="1" value="<?php echo $loan_purchase_amount; ?>" id="loan_purchase_amountRange">
                                          </div>
                                       </div>
                                    </div>
                                    <!-- end purchase amount-->
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                       <div class="form-group">
                                          ...
                                          <input class="touchspin3" type="text" value="<?php echo $other_exp_capital; ?>" name="other_exp_capital" id="other_exp_capital" calc="loan_purchase_cost">
                                          <div class="range-container">
                                             <input type="range" min="0" max="100" step="1" value="<?php echo $other_exp_capital; ?>" id="other_exp_capitalRange">
                                          </div>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                       <div class="form-group">
                                          ...
                                          <input class="touchspin3" type="text" value="<?php echo $other_exp_slicitor_cost; ?>" name="other_exp_slicitor_cost" id="other_exp_slicitor_cost" calc="loan_purchase_cost">
                                          <div class="range-container">
                                             <input type="range" min="0" max="100" step="1" value="<?php echo $other_exp_slicitor_cost; ?>" id="other_exp_slicitor_costRange">
                                          </div>
                                       </div>
                                    </div>
                                    <!-- end solicitor cost-->
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                       <div class="form-group">
                                          <label>Other($) *</label>
                                          <input class="touchspin3" type="text" value="<?php echo $other_exp_other; ?>" name="other_exp_other" id="other_exp_other" calc="loan_purchase_cost">
                                          <div class="range-container">
                                             <input type="range" min="0" max="10000" step="1" value="<?php echo $other_exp_other; ?>" id="other_exp_otherRange">
                                          </div>
                                       </div>
                                    </div>
                                    <!-- end other-->
                                    ...
                                    <div class="tab-pane active" id="contact_01">
                                       <div class="" id="anaBody">
                                          <div class="row">
                                             <div class="col-4 mb-3">
                                                <div class="i-checks">
                                                   <label><input type="radio" <?php if($loan_pricipal_interest=="io"){?> Checked <?php }?>  value="io" name="loan_pricipal_interest  " id="loan_pricipal_interest  "  calc="loan_purchase_cost"> Interest Only</label>
                                                </div>
                                             </div>
                                             <div class="col-6 mb-3">
                                                <div class="i-checks">
                                                   <label><input type="radio" <?php if($loan_pricipal_interest=="pi"){?> Checked <?php }?>   value="pi" name="loan_pricipal_interest  " id="loan_pricipal_interest  " calc="loan_purchase_cost"> Principal & interest</label>
                                                </div>
                                             </div>
                                          </div>
                                          <div class="row">
                                             ...
                                             <div class="col-12 col-md-4 col-lg-4 col-xxl-4 range-form-group">
                                                <div class="form-group">
                                                   ...
                                                   <div class="row">
                                                      <div class="col-9">
                                                         <input class="touchspin3" type="text" value="<?php echo $loan_length_year; ?>" name="loan_length_year" id="loan_length_year" calc="loan_purchase_cost"> 
                                                      </div>
                                                      <label class="col-form-label col-3">years &</label>
                                                   </div>
                                                   <div class="row">
                                                      <div class="col-9">
                                                         <input class="touchspin3" type="text" value="<?php echo $loan_length_month; ?>" name="loan_length_month" id="loan_length_month" calc="loan_purchase_cost">
                                                      </div>
                                             ...
                                             <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                                <div class="form-group">
                                                   ...
                                                   <input class="touchspin3" type="text" value="<?php echo $loan_amount_loan; ?>" name="loan_amount_loan" id="loan_amount_loan" >
                                                   <div class="range-container">
                                             ...
                                             <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                                <div class="form-group">
                                                   ...
                                                   <input class="touchspin3" type="text" value="<?php echo $loan_esatblishment_fee; ?>" name="loan_esatblishment_fee" id="loan_esatblishment_fee" calc="loan_purchase_cost" >
                                                   <div class="range-container">
                                                      <input type="range" min="0" max="10000" step="1" value="<?php echo $loan_esatblishment_fee; ?>" id="loan_esatblishment_feeRange">
                                                   </div>
                                                </div>
                                             </div>
                                             ...
                                             <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                                <div class="form-group">
                                                   ...
                                                   <input class="touchspin3" type="text" value="<?php echo $loan_interset_rate; ?>" name="loan_interset_rate" id="loan_interset_rate" calc="loan_purchase_cost">
                                                   <div class="range-container">
                                                      <input type="range" min="0" max="10000" step="1" value="<?php echo $loan_interset_rate; ?>" id="loan_interset_rateRange">
                                                   </div>
                                                </div>
                                             </div>
                                             <!-- end intrerest rate-->
                                             ...
                                             <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                                <div class="form-group">
                                                   ...
                                                   <input class="touchspin3" type="text" value="<?php echo $loan_other_loan_costs; ?>" name="loan_other_loan_costs" id="loan_other_loan_costs" calc="loan_purchase_cost">
                                                   <div class="range-container">
                                                      <input type="range" min="0" max="10000" step="1" value="<?php echo $loan_other_loan_costs; ?>" id="loan_other_loan_costsRange">
                                                   </div>
                                                </div>
                                             </div>
                                             <!-- end other-->
                                             ...
                                             <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                                <div class="form-group">
                                                   ...
                                                   <input class="touchspin3" type="text" value="<?php echo $loan_valuation_fees; ?>" name="loan_valuation_fees" id="loan_valuation_fees" calc="loan_purchase_cost">
                                                   <div class="range-container">
                                                      <input type="range" min="0" max="10000" step="1" value="<?php echo $loan_valuation_fees; ?>" id="loan_valuation_feesRange">
                                                   </div>
                                                </div>
                                             </div>
                                             <!-- end other-->
                     ...
                     <div class="card my-4">
                        ...
                        <div class="card-body">
                           <div class="row">
                              ...
                              <div class="col-4 mb-3">
                                 <div class="i-checks">
                                    <label><input type="radio" <?php if($arr_rental_type=="longterm"){?> Checked <?php }?> value="longterm" name="arr_rental_type" id="arr_rental_type"  checked> Resident long term</label>
                                 </div>
                              </div>
                              <div class="col-4 mb-3">
                                 <div class="i-checks">
                                    <label><input type="radio" <?php if($arr_rental_type=="holidayrental"){?> Checked <?php }?>  value="holidayrental" name="arr_rental_type" id="arr_rental_type" > Holiday rental</label>
                                 </div>
                              </div>
                           </div>
                           <div class="row">
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <div class="input-icon">
                                       <input class="touchspin3" type="text" value="<?php echo $arr_annual_rr; ?>" name="arr_annual_rr" id="arr_annual_rr">
                                    </div>
                                    <div class="range-container">
                                       <input type="range" min="0" max="10000" step="1" value="<?php echo $arr_annual_rr; ?>" id="arr_annual_rrRange">
                                    </div>
                                 </div>
                              </div>
                              <!-- end deposit percentage-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin3" type="text" value="<?php echo $arr_weekly_rents; ?>" name="arr_weekly_rents" id="arr_weekly_rents" >
                                    <div class="range-container">
                        ...
                        <div class="card-body">
                           <div class="row">
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                 <div class="form-group">
                                    <label>Rates($) *</label>
                                    <input class="touchspin3" type="text" value="<?php echo $ape_rates; ?>" name="ape_rates" id="ape_rates" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="10000" step="1" value="<?php echo $ape_rates; ?>" id="ape_ratesRange">
                                    </div>
                                 </div>
                              </div>
                              <!-- end capital improvement-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin3" type="text" value="<?php echo $ape_body_corporate; ?>" name="ape_body_corporate" id="ape_body_corporate" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="10000" step="1" value="<?php echo $ape_body_corporate; ?>" id="ape_body_corporateRange">
                                    </div>
                                 </div>
                              </div>
                              <!-- end solicitor cost-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin3" type="text" value="<?php echo $ape_land_lease_fee; ?>" name="ape_land_lease_fee" id="ape_land_lease_fee" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="10000" step="1" value="<?php echo $ape_land_lease_fee; ?>" id="ape_land_lease_feeRange">
                                    </div>
                                 </div>
                              </div>
                              <!-- end stamping fee-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin3" type="text" value="<?php echo $ape_insurance; ?>" name="ape_insurance" id="ape_insurance" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="10000" step="1" value="<?php echo $ape_insurance; ?>" id="ape_insuranceRange">
                                    </div>
                                 </div>
                              </div>
                              <!-- end other-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin3" type="text" value="<?php echo $ape_letting_fees; ?>" name="ape_letting_fees" id="ape_letting_fees" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="10000" step="1" value="<?php echo $ape_letting_fees; ?>" id="ape_letting_feesRange">
                                    </div>
                                 </div>
                              </div>
                              <!-- end Letting fees($)*-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin3" type="text" value="<?php echo $ape_management_fees; ?>" name="ape_management_fees" id="ape_management_fees" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="10000" step="1" value="<?php echo $ape_management_fees; ?>" id="ape_management_feesRange">
                                    </div>
                                 </div>
                              </div>
                              <!-- end Management fees(%)*-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin3" type="text" value="<?php echo $ape_repairs_maitenance; ?>" name="ape_repairs_maitenance" id="ape_repairs_maitenance" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="10000" step="1" value="<?php echo $ape_repairs_maitenance; ?>" id="ape_repairs_maitenanceRange">
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin3" type="text" value="<?php echo $ape_gardening; ?>" name="ape_gardening" id="ape_gardening" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="10000" step="1" value="<?php echo $ape_gardening; ?>" id="ape_gardeningRange">
                                    </div>
                                 </div>
                              </div>
                              <!-- end Gardening($)*-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin3" type="text" value="<?php echo $ape_cleaning; ?>" name="ape_cleaning" id="ape_cleaning" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="10000" step="1" value="<?php echo $ape_cleaning; ?>" id="ape_cleaningRange">
                                    </div>
                                 </div>
                              </div>
                              <!-- end Cleaning($)*-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin3" type="text" value="<?php echo $ape_service_contract; ?>" name="ape_service_contract" id="ape_service_contract" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="10000" step="1" value="<?php echo $ape_service_contract; ?>" id="ape_service_contractRange">
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    <label>Other($)*</label>
                                    <input class="touchspin3" type="text" value="<?php echo $ape_other; ?>" name="ape_other" id="ape_other" calc='AnnualPropertyExpense' >
                                    <div class="range-container">
                                       <input type="range" min="0" max="10000" step="1" value="<?php echo $ape_other; ?>" id="ape_otherRange">
                                    </div>
                                 </div>
                              </div>
                              <!-- end Other($)*-->
                           ...
                           <div class="row">
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin3" type="text" value="<?php echo $ae_entity_rows; ?>" name="ae_entity_rows" id="ae_entity_rows" >
                                    <div class="range-container">
                           ...
                           <div class="row">
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin3" type="text" value="<?php echo $mf_customer_price_index; ?>" name="mf_customer_price_index" id="mf_customer_price_index" >
                                    <div class="range-container">
                                       <input type="range" min="0" max="10000" step="1" value="<?php echo $mf_customer_price_index; ?>" id="mf_customer_price_indexRange">
                                    </div>
                                 </div>
                              </div>
                              <!-- end Entity rows-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin3" type="text" value="<?php echo $mf_capital_growth; ?>" name="mf_capital_growth" id="mf_capital_growth" >
                                    <div class="range-container">
                                       <input type="range" min="0" max="10000" step="1" value="<?php echo $mf_capital_growth; ?>" id="mf_capital_growthRange">
                                    </div>
                                 </div>
                              </div>
                              <!-- end Entity rows-->
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin3" type="text" value="<?php echo $mf_land_tax; ?>" name="mf_land_tax" id="mf_land_tax" >
                                    <div class="range-container">
                           ...
                           <div class="row">
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin3" type="text" value="<?php echo $de_construction_year_completed; ?>" name="de_construction_year_completed" id="de_construction_year_completed" >
                                    <div class="range-container">
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <input class="touchspin3" type="text" value="<?php echo $de_estimate_land_value; ?>" name="de_estimate_land_value" id="de_estimate_land_value" >
                                    <div class="range-container">
    ...
    */
    ...
    $(document).ready(function(){
        $(document).on("click", "#analyser .last", function(){   //#analyser-t-3
            ...
            $.ajax({
					type: "POST",
					url:"https://duvalknowledge.com/dpo/ajax/AnalyzerResult.html",
					data: datavalues 
				}).done(function( data ) {
                    Obj.html(data);
                });
