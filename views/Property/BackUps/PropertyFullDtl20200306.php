                              ...
                              <div class="card-body">
                                 <div class="row">
                                      <div class="col-6 col-md-4 col-lg-4 mb-3">
                                        <input type="radio" <?php if($property_purchase_value_price=="rateamount"){?> Checked <?php }?> value="rateamount" name="property_purchase_value_price" id="property_purchase_value_price"  onclick="OnClickRadio(this);" <?php echo  $PurchasePriceChecked;?> > 
                                        <label for="property_purchase_value_price">Enter as $ value</label>
                                     </div>
                                     <div class="col-6 mb-3">
                                        <input type="radio" <?php if($property_purchase_value_price=="ratepercentage"){?> Checked <?php }?>  value="ratepercentage" name="property_purchase_value_price" id="property_purchase_value_percent"  onclick="OnClickRadio(this);" >
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                       <div class="form-group">
                                          ...
                                          <div class="range-container">
                                             <input type="range" min="0" max="100000" step="1" value="<?php echo $loan_purchase_market_value; ?>" id="loan_purchase_market_valueRange" calc='loan_purchase_cost' >
                                          </div>
                                       </div>
                                    </div>
                                    <!-- end market value-->
                           ...
                           <div class="row">
                              ...
                              <div class="col-12 col-md-4 col-lg-4 col-xxl-3 offset-xxl-1 range-form-group">
                                 <div class="form-group">
                                    ...
                                    <div class="range-container">
                                       <input type="range" min="0" max="10000" step="1" value="<?php echo $ape_management_fees; ?>" id="ape_management_feesRange" calc='AnnualPropertyExpense' >
                                    </div>
                                 </div>
                              </div>
                              <!-- end Management fees(%)*-->
