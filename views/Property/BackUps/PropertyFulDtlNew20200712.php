...
<div class="row">
	...
	<div class="form-group col-md-4">
		...
		<input class="form-control DuvalDynamicPrice" type='type' name='DuvalDynamicPrice' id='DuvalDynamicPrice' rel='calculate' value='<?php echo $DuvalDynamicPrice; ?>' <?php echo $DuvalPriceReadOnly; ?>>
	</div>
	<?php } else { ?>
	<div class="form-group col-md-4">
	...
	<div class="form-group col-md-4">
		...
		<input class="form-control StampDuty" type='type' name='StampDuty' id='StampDuty' rel='calculate' value='<?php echo $StampDuty; ?>' >
	</div>
					               ...
					               <div class="form-group col-md-4">
    					               <div class="input-group mb-4">
                                            <div class="input-group-prepend">
                                               ...
                                               <input class="form-control" type='type' name='StagePay1Amt' id='StagePay1Amt' readonly  rel='calculate' value='<?php echo $StagePay1Amt; ?>'>
                                            </div>
                                       </div>
					               </div>
					               ...
					               <div class="form-group col-md-4">
    					               <div class="input-group mb-4">
                                            <div class="input-group-prepend">
                                               ...
                                               <input class="form-control" type='type' name='StagePay2Amt' id='StagePay2Amt' readonly  rel='calculate' value='<?php echo $StagePay2Amt; ?>'>
                                            </div>
                                       </div>
					               </div>
