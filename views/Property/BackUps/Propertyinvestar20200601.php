...
<div class="content">
                                ...
                                <div class="filter-box-inner">
                                  ...
                                  <div class="row">
                                    <div class="col text-left">
                                      <button class="btn btn-default" id="Remove" name="Remove" type="button">Remove</button>
                                    </div>
                                    <div class="col text-right">
                                      <button class="btn btn-success" id="Apply" name="Apply"  type="button">Apply</button>
                                    </div>
                                  </div>
                                </div>
                              </div>
   ...
   <?php 
         echo \api\apiClass::ProductFeatureApiUk($LocationId,$datasource,$BuildType,$bedrooms);
...
$(document).ready(function(){
 ...
 $("#Apply").on("click",function(e){
   ...
   // alert("bedrooms="+bedrooms);
    ...
    window.location.href = "<?php echo SITE_BASE_URL;?>Property/PropertyInvestar.html?country=" + countryId + "&datasource=" + datasource + "&BuildType=" + BuildType +"&bedrooms="+bedrooms +"&LocationId="+ LocationId +"&Subrub="+Subrub;
