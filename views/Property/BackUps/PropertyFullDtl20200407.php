            ...
            <form class="dpo-form"  action="<?php echo SITE_BASE_URL;?>/Property/propertysave.html?buttonaction=<?php echo $action;?>&user_id=<?php echo $user_id;?>&property_id=<?php echo $ProprtyId;?>" method="post"   >
               <div id="analyser">
                           ...
                           <div class="row">
                               ...
                               <table width='100%'>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type='text' name='Finalcapitalpayment' id='Finalcapitalpayment' value=''>&nbsp;&nbsp;of Purchase Price</td>
                                        <td><input type='text' name='FinalcapitalpaymentAmt' id='FinalcapitalpaymentAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><input type='text' name='FinalcapitalpaymentSecAmt' id='FinalcapitalpaymentSecAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><textarea name='FinalcapitalpaymentRemarks' id='FinalcapitalpaymentRemarks'  rows=5 cols=15 ></textarea></td>
                                    </tr>
                                     <tr>
                                        <td>Stamp duty</td>
                                        <td><input type='text' name='Stampduty' id='Stampduty' value=''>&nbsp;&nbsp;Based on the Purchase Price</td>
                                        <td><input type='text' name='StampdutyAmt' id='StampdutyAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><input type='text' name='StampdutySecAmt' id='StampdutySecAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><textarea name='StampdutyRemarks' id='StampdutyRemarks'  rows=5 cols=15 ></textarea></td>
                                    </tr>
                                     <tr>
                                        <td>Liquid Expat broker costs</td>
                                        <td><input type='text' name='LiquidExpatbrokercosts' id='LiquidExpatbrokercosts' value=''>&nbsp;&nbsp;of the Loan Amount</td>
                                        <td><input type='text' name='LiquidExpatbrokercostsAmt' id='LiquidExpatbrokercostsAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><input type='text' name='LiquidExpatbrokercostsSecAmt' id='LiquidExpatbrokercostsSecAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><textarea name='LiquidExpatbrokercostsRemarks' id='LiquidExpatbrokercostsRemarks'  rows=5 cols=15 ></textarea></td>
                                    </tr>
                                     <tr>
                                        <td>Lender arrangement fee</td>
                                        <td><input type='text' name='Lenderarrangementfee' id='Lenderarrangementfee' value=''>&nbsp;&nbsp;of the Loan Amount</td>
                                        <td><input type='text' name='LenderarrangementfeeAmt' id='LenderarrangementfeeAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><input type='text' name='LenderarrangementfeeSecAmt' id='LenderarrangementfeeSecAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><textarea name='LenderarrangementfeeRemarks' id='LenderarrangementfeeRemarks'  rows=5 cols=15 ></textarea></td>
                                    </tr>
                                     <tr>
                                        <td>Valuation fee (Inc. VAT)</td>
                                        <td><input type='text' name='Valuationfee' id='Valuationfee' value=''>&nbsp;&nbsp;Based on the Purchase Price</td>
                                        <td><input type='text' name='ValuationfeeAmt' id='ValuationfeeAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><input type='text' name='ValuationfeeSecAmt' id='ValuationfeeSecAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><textarea name='ValuationfeeRemarks' id='ValuationfeeRemarks'  rows=5 cols=15 ></textarea></td>
                                    </tr>
                                    <tr>
                                        <td colspan=2>Furniture pack (Inc. VAT)</td>
                                         <td><input type='text' name='Furniturepack' id='Furniturepack' value=''>&nbsp;&nbsp;Based on Unit Type</td>
                                        <td><input type='text' name='FurniturepackAmt' id='FurniturepackSecAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><input type='text' name='FurniturepackSecAmt' id='FurniturepackSecAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><textarea name='FurniturepackRemarks' id='FurniturepackRemarks'  rows=5 cols=15 ></textarea></td>
                                    </tr>
                                       <tr>
                                        <td colspan=2>Complete Tenant find fee (Inc. VAT)</td>
                                         <td><input type='text' name='CompleteTenantfee' id='CompleteTenantfee' value=''>&nbsp;&nbsp;Based on 1 Tenaunt</td>
                                        <td><input type='text' name='CompleteTenantfeeAmt' id='CompleteTenantfeeAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><input type='text' name='CompleteTenantfeeSecAmt' id='CompleteTenantfeeSecAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><textarea name='CompleteTenantfeeRemarks' id='CompleteTenantfeeRemarks'  rows=5 cols=15 ></textarea></td>
                                    </tr>
                                    <tr>
                                        <td colspan=2>Complete Tenant agreement fee (Inc. VAT)</td>
                                        <td><input type='text' name='CompleteTenantagreementfee ' id='CompleteTenantagreementfee' value=''>&nbsp;&nbsp;Based on 1 Tenaunt</td>
                                        <td><input type='text' name='CompleteTenantagreementfeeAmt' id='CompleteTenantagreementfeeAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><input type='text' name='CompleteTenantagreementfeeSecAmt' id='CompleteTenantagreementfeeSecAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><textarea name='CompleteTenantagreementfeeRemarks' id='CompleteTenantagreementfeeRemarks'  rows=5 cols=15 ></textarea></td>
                                    </tr>
                                    <tr>
                                        <td colspan=2>Complete Handover fee (Inc. VAT)</td>
                                        <td><input type='text' name='CompleteHandoverfee' id='CompleteHandoverfee' value=''>&nbsp;&nbsp;Based on Unit Type</td>
                                        <td><input type='text' name='CompleteHandoverfeeAmt' id='CompleteHandoverfeeAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><input type='text' name='CompleteHandoverfeeSecAmt' id='CompleteHandoverfeeSecAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><textarea name='CompleteHandoverfeeRemarks' id='CompleteHandoverfeeRemarks'  rows=5 cols=15 ></textarea></td>
                                    </tr>
                                    <tr>
                                        <td colspan=2>Complete Inventory fee (Inc. VAT)</td>
                                        <td><input type='text' name='CompleteInventoryfee' id='CompleteInventoryfee' value=''>&nbsp;&nbsp;Based on Unit Type</td>
                                        <td><input type='text' name='CompleteInventoryfeeAmt' id='CompleteInventoryfeeAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><input type='text' name='CompleteInventoryfeeSecAmt' id='CompleteInventoryfeeSecAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><textarea name='CompleteInventoryfeeRemarks' id='CompleteInventoryfeeRemarks'  rows=5 cols=15 ></textarea></td>
                                    </tr>
                                    <tr>
                                        <td colspan=2>Complete Reference Check (inc. VAT)</td>
                                        <td><input type='text' name='CompleteReferenceCheck' id='CompleteReferenceCheck' value=''>&nbsp;&nbsp;Based on 1 Tenaunt</td>
                                        <td><input type='text' name='CompleteReferenceCheckAmt' id='CompleteReferenceCheckAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><input type='text' name='CompleteReferenceCheckSecAmt' id='CompleteReferenceCheckSecAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><textarea name='CompleteReferenceCheckRemarks' id='CompleteReferenceCheckRemarks'  rows=5 cols=15 ></textarea></td>
                                    </tr>
                                    <tr>
                                        <td colspan=2>Client Fee Rebate on Completion </td>
                                        <td><input type='text' name='ClientFeeRebateComp' id='ClientFeeRebateComp' value=''>&nbsp;&nbsp;Per Unit</td>
                                        <td><input type='text' name='ClientFeeRebateCompAmt' id='ClientFeeRebateCompAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><input type='text' name='ClientFeeRebateCompSecAmt' id='ClientFeeRebateCompSecAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><textarea name='ClientFeeRebateCompRemarks' id='ClientFeeRebateCompRemarks'  rows=5 cols=15 ></textarea></td>
                                    </tr>
                                    ...
                                    <tr>
                                            ...
                                            <td  align='right' >0</td><input type='type' name='PaymentOnCompleteion' id='PaymentOnCompleteion' value='25'></td>
                                            <td align='right' >0<input type='hidden' name='PaymentOnCompleteionSecAmount' id='PaymentOnCompleteionSecAmount' value=''></td>
                                            <td>&nbsp;</td>
                                    </tr>
                                     <tr>
                                           
                                            <td>Total Equity Required</td>
                                            <td  align='right' >0</td><input type='type' name='TotalEquityRequired' id='TotalEquityRequired' value='25'></td>
                                            <td align='right' >0<input type='hidden' name='TotalEquityRequiredSecAmount' id='TotalEquityRequiredSecAmount' value=''></td>
                                            <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                            <td>Mortgage Amount</td>
                                            <td  align='right' >0</td><input type='type' name='TotalMortgageAmount' id='TotalMortgageAmount' value='25'></td>
                                            <td align='right' >0<input type='hidden' name='TotalMortgageAmountSecAmount' id='TotalMortgageAmountSecAmount' value=''></td>
                                            <td>&nbsp;</td>
                                    </tr>
                  ...
                  <section>
                     ...
                     <div class="card my-4">
                        <div class="card-header">
                           <div class="card-title">Estimated monthly income</div>
                        </div>
                        <div class="card-body">
                           <div class="row">
                               ...
                               <table width='100%'>
                                    <tr>
                                        ...
                                        <td><input type='text' name='Finalcapitalpayment' id='Finalcapitalpayment' value=''>&nbsp;&nbsp;Per Unit</td>
                                        <td><input type='text' name='FinalcapitalpaymentAmt' id='FinalcapitalpaymentAmt' value=''>&nbsp;&nbsp;</td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type='text' name='ServiceCharge' id='ServiceCharge' value=''>&nbsp;&nbsp;Per Unit</td>
                                        <td><input type='text' name='ServiceChargeAmt' id='ServiceChargeAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><input type='text' name='ServiceChargeSecAmt' id='ServiceChargeAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><textarea name='ServiceChargeRemarks' id='ServiceChargeRemarks'  rows=5 cols=15 ></textarea></td>
                                    </tr>
                                     <tr>
                                        <td>Tenant Management Fee</td>
                                        <td><input type='text' name='TenantManagementFee' id='TenantManagementFee' value=''>&nbsp;&nbsp;of Purchase Price</td>
                                        <td><input type='text' name='TenantManagementFeeAmt' id='TenantManagementFeeAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><input type='text' name='TenantManagementFeeSecAmt' id='TenantManagementFeeSecAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><textarea name='TenantManagementFeeRemarks' id='TenantManagementFeeRemarks'  rows=5 cols=15 ></textarea></td>
                                    </tr>
                                     <tr>
                                        <td>Ground Rent</td>
                                        <td><input type='text' name='GroundRent' id='Ground Rent' value=''>&nbsp;&nbsp;based on Riseam Sharples</td>
                                        <td><input type='text' name='Ground RentAmt' id='Ground RentAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><input type='text' name='Ground RentSecAmt' id='Ground RentSecAmt' value=''>&nbsp;&nbsp;</td>
                                        <td><textarea name='Ground RentRemarks' id='Ground RentRemarks'  rows=5 cols=15 ></textarea></td>
                                    </tr>
                                 </table>
                        </div>
                     </div>
