...
if( $IsALl == true )
{
        ...
        //if ($DataSrc == "Discnt"){
                ...
                if( $DataSrc == "RentAsk"){
                     ...
                     $ProductName = "Average Asking Price (Rentals)";
                }
                    
                if( $DataSrc == "sqfiRent"){
                   
                    $ProductName = "Average Asking Price Per FT<sup>2</sup> (Rentals)";
                }
                    
                if( $DataSrc == "sqfiSales"){
                  
                    $ProductName = "Average Asking Price Per FT<sup>2</sup> (Sales)";
                }
                    
                if( $DataSrc == "PriPaid"){
                   
                    $ProductName = "Average Price Paid (Rentals)";
                }
                                ...
                                <table class="analysis-table table table-striped">
                                  ...
                                  <tbody>
                                      ...
                                      <?php //include_once("corelogic-json-test.php"); 
                                        ...
                                        if ($DataSrc == "PriAsk" || $DataSrc == "RentAsk" || $DataSrc == "sqfiRent" || $DataSrc == "sqfiSales" || $DataSrc == "PriPaid" || $DataSrc == "NewRentList" || $DataSrc == "SalesList" || $DataSrc == "NewSalesList" || $DataSrc == "SalesTrans" || $DataSrc == "PropSize" ){ 
                                            
                                           //echo "ProductFeatureApiUkValue= " . date("Y-m-d H:i:s");
