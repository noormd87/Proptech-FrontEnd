...
<?php
   ...
   if  ( $RecentAnalyse == "Y" || $IsProtFolio == "Y"){
   ...
   */
   ...
   if ($countryid == "AU" || $countryid == "GB" || $countryid == "NZ"){
       $IsAuGbNz                   = true;
   }
   ...
   $CurrencySym             				= $ChkSymbolArr["0"] ."&nbsp;".$countryid;
   ...
   
   {
      ...
      if ($IsAuGbNz){  //Yasir / 28-Jun-2020 / For other countries should load without datas...
           ...
           if (!isset($LoanAmountPer))              $Topup						= 0;
                        ...
                        <div class="card-body">
                           ...
                           <div class="">
                              ...
                              <table class="table">
                                 ...
                                 <tr>
                                    <td width="50%">Do you have a personal Allowance?</td>
                                    <td width="50%">
                              ...
                              ?>
                              <h4 class="card-title">DuVal Dynamic Price (<?php echo $CurrencySym; ?>): </h4>
                              <table class="table">
...
<div class="row">
	<div class="form-group col-md-4">
		<label>Income (<?php echo $CurrencySym; ?>)</label>
    ...
    ?>
     <div class="form-group col-md-4">
	    <label>Mortgage Registration (<?php echo $CurrencySym; ?>)</label>
	    <input class="form-control" type='type' name='MortgageRegistration' id='MortgageRegistration' rel='calculate' value='<?php echo $MortgageRegistration; ?>' >
	 </div>
	 <div class="form-group col-md-4">
	    <label>Transfer Fee/Lease Registration (<?php echo $CurrencySym; ?>)</label>
	    <input class="form-control" type='type' name='TransferFees' id='TransferFees' rel='calculate' value='<?php echo $TransferFees; ?>' >
	 </div>
    <?php 
	 }
	 ...
	 <div class="form-group col-md-4" <?php echo $HideDate;?> >
			...
			<input class="form-control date_picker" type="text" placeholder="dd/mm/yy" autocomplete='off' name="DateCompletion" id ="DateCompletion" value="<?php echo $DateCompletion; ?>" >
					      ...
					      <div class="card-body">
					         ...
					         <div class="row">
					               ...
					               <div class="form-group col-md-4">
					                  ...
					                  <input class="form-control" type='type' name='Topup' id='Topup' rel='calculate' value='<?php echo $Topup; ?>' <?php echo $TopUpReadonly; ?> > 
					               </div>
					            </div>
					      </div>
					   </div>
					   ...
					   <div id="collapse4" class="collapse" data-parent="#accordion4">
					      <div class="card-body">
					         ...
					         <div class="row">
					               ...
					               <div class="form-group col-md-4">
					                  <label>Council/Property Tax (p.a.) (<?php echo $CurrencySym; ?>)</label>
					               ...
					               <div class="form-group col-md-4">
					                  <label>Body Corporate/Strata/Service Charge (p.a.) (<?php echo $CurrencySym; ?>)</label>
					               ...
					               <div class="form-group col-md-4">
					                  <label>Cleaning (per month) (<?php echo $CurrencySym; ?>)</label>
					               ...
					               <div class="form-group col-md-4">
					                  <label>Gardening (per month) (<?php echo $CurrencySym; ?>)</label>
					               ...
					               <div class="form-group col-md-4">
					                  <label>Service Contracts (p.a.) (<?php echo $CurrencySym; ?>)</label>
					      ...
					      <div class="card-body">
					         ...
					         <div class="row">
					               ...
					               <div class="form-group col-md-4">
					                  ...
					                  <input class="form-control" type='type' name='InitialLoanAmt' id='InitialLoanAmt' rel='calculate' value='<?php echo $InitialLoanAmt; ?>' 
					               ...
					               <div class="form-group col-md-4">
					                  <label><?php echo ($IsAuGbNz == true) ? "" : "Remaining"; ?>Term (Years) (<?php echo $CurrencySym; ?>)</label>
					               ...
					               <div class="form-group col-md-4">
					                  <label>Interest Only/Principal & Interest</label><br>
					                   <input type="radio" name="IntOrPrincipalInt" id="IntOrPrincipalInt1" value="InterestOnly"  >
                                       <label for="IntOrPrincipalInt1">Interest Only</label>
                                       
                                       <input type="radio" name="IntOrPrincipalInt" id="IntOrPrincipalInt2" value="PrinicipalAndInterest" checked >
					...
					<div class="card" <?php echo $hideDep; ?> >
					   <div class="card-header">
...
<div class="row">
   ...
   <?php } ?>
                  <div class="col-lg-12">
                     ...
                     <div class="input-group mb-3">
                        <div class="input-group-prepend">
                           <span class="input-group-text">Useful Life (<?php echo $CurrencySym; ?>)</span>
                        </div>
...
<script>
      $(document).ready(function(){
           ...
           $(".date_picker").datepicker({
            ...
            jQuery('.date_picker_autoclose').datepicker({
            format: "dd/mm/yy",
            autoclose: true,
            todayHighlight: true
        });
