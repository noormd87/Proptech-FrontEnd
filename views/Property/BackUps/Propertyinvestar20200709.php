               ...
               <div class="col-lg-12">
                  <div class="card filter-card">
                     ...
                     <!--
                      ...
                      -->
                      <input class="custom-form-control" type="text" name="datefilter" value="<?php echo $datefilter; ?>" />
                                ...
                                <div class="filter-box-inner">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col text-right">
                                      ...
                                      <input class="btn btn-success  SearchBtn" type="submit" name="Apply1" id="Remove1" value="Apply">
                                    </div>
                                  </div>
                                </div>
                              </div>
...
new mapboxgl.Marker().setLngLat(feature.center).addTo(map);
                    ...
                    <div class="card-body">
                             <div class="table-responsive quartiles">
                                    ...
                                    <?php //include_once("corelogic-json-test.php"); 
                                        ...
                                        $PeopleAndPopulationArr  =  \api\apiClass::PeopleAndPopulationApiClass($LocationId,$datefilter); 
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                          ...
                          <?php //include_once("corelogic-json-test.php"); 
                            ...
                            $productDetailsArr  =  \api\apiClass::ProductFeatureApiUk("forDet",$LocationId,$datasource,$BuildType,$bedrooms,$propertyType,$datefilter);
   ...
   <?php 
         echo \api\apiClass::ProductFeatureApiUk("formap",$LocationId,$datasource,$BuildType,$bedrooms,$propertyType,$datefilter);
         echo \api\apiClass::EducationByLevelApiUK($LocationId,$datefilter);
