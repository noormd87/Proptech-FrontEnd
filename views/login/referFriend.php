...
<div class="inner-wrapper">
    ...
    <div class="refer-panel">
        <h1 class="hero-title-dark">Refar A Friend</h1>
        <div class="friend-content">
            <div class="row">
                <div class="col-xl-6 col-12 full-early">
                    <div class="hero-text">
                        <h2>Refer A friend</h2>
                        <p>Never before have investors been rewarded for their investment and loyalty. As a member of Du Val PropTech, you are automatically enrolled into our Du Val Rewards Program and have access to an unrivalled level of benefits and rewards. The more you spend the greater the reward.</p>
                        <!--<button class="btn btn-orange">Check Your Points</button>-->
                    </div>
                </div>
            </div>
            <div class="d-flex align-items-start">
                ...
                <div class="share-link flex-grow-1">
                    ...
                    <div class="row sharing">
                        ...
                        <button type="submit" class="btn btn-outline-light" onclick="copyText()">Copy</button>
                        <button type="submit" class="btn btn-white" data-toggle="modal" data-target="#referFriend">Invite a Friend</button>
                    </div>
    ...
    <div class="refer-tables">
        <h1 class="hero-title-dark">Referral History</h1>
        <div class="rt-panel">
                ...
                <tbody>
                    ...
                    foreach ($rows as $row) {
                        ...
                        <tr>
                            <td>
                                <div class="">
                                    <img src="<?php echo SITE_BASE_URL; ?>uploads/ProfilePic/<?php echo $Image; ?>" class="img-fluid rounded-circle" style="max-width: 50px;" alt=""> <?php echo $Users; ?>
                                </div>
                            </td>
                            <td><?php echo $points; ?></td>
                            <td class="text-muted"><?php echo $ReferredOn; ?></td>
                            <td class="text-muted"><?php echo $createdOn; ?></td>
                            <td class="text-sucess"><?php echo $Status; ?></td>
                        </tr>
                        <?php
                        $i = $i + 1;
                    }
...
<script type="text/javascript">
    (function () {
        var options = {
            ...
            whatsapp: "8181909857", // WhatsApp number
            viber: "8181909857", // Viber number
            snapchat: "8181909857", // Snapchat username
            line: "8181909857", // Line QR code URL
            telegram: "8181909857", // Telegram bot username
            sms: "+918181909857", // Sms phone number
            call: "8181909857", // Call phone number
            ...
            order: "facebook,instagram,whatsapp,call,viber,snapchat,line,telegram,sms", // Order of buttons
