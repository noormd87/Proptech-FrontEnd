                ...
                <div class="basic-list-group">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                          <a class="nav-link" href="<?php echo SITE_BASE_URL;?>Property/PropertyInvestar.html?country=1"><img src="<?php echo SITE_BASE_URL;?>assets/img/flags/nz.png"> &nbsp; New Zealand</a>
                        </li>
                        <li class="list-group-item"><a class="nav-link" href="<?php echo SITE_BASE_URL;?>Property/PropertyInvestar.html?country=3"><img src="<?php echo SITE_BASE_URL;?>assets/img/flags/uk.png"> &nbsp;United Kingdom</a></li>
                        <li class="list-group-item"><a class="nav-link" href="<?php echo SITE_BASE_URL;?>Property/PropertyInvestar.html?country=2"><img src="<?php echo SITE_BASE_URL;?>assets/img/flags/australia.png"> &nbsp; Australia</a></li>
                       <!--
    ...
    jQuery('#worldMap').vectorMap({
      ...
      onRegionClick: function (element, code, region) {
        var message = 'You clicked "' +
          ...
          //alert(CountryCode);
          if ( CountryCode == "GB" || CountryCode == "NZ" || CountryCode =="AU" ) {
             ...
             window.location.href = "<?php echo SITE_BASE_URL; ?>Property/PropertyInvestar.html?country=" + codenew;
          }else{
