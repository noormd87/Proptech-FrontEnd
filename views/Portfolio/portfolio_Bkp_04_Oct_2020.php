...
<div class="inner-wrapper">
    <form action="#" id="" class="" method="post" name='frm'>
        ...
        ?>
        <!--<a href="<?php echo SITE_BASE_URL;?>Property/PropertyDelete.html?id=<?php echo $ProprtyId;?>&countryid=<?php echo $countryid;?>&autoid=<?php echo $autoid;?>&IsProtFolio=Y" class="dropdown-item f-s-12">Delete</a>-->
        <div class="portfolio-panel" <?php echo $HidePropertyList; ?>>
            <div class="row">
                <?php
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="p-box">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <input type="checkbox" class="input_check" checked name="PropertyChecked"  id="PropertyChecked<?php echo $i; ?>"  value='<?php echo $autoid; ?>'  >
                            </div>
        ...
        <div class="row"  >
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <div class=""> 
                            <div class="pull-left" ><h4 class="card-title">Investment Comparison</h4></div>
                            <div class="pull-right">
                                <h4 class="card-title">Currency : (<?php echo $currentCurrency; ?>)</h4>
                            </div>
                        </div>
                        <div class="">
                            <table class="table table-bordered table-striped mb-0">  
                                ...
                                $IndexQry = "select 'Analysed Properties' as Headers, '' as columns , '' as feildname, 'Text' as datatype, '' as Rateper from dual union all select  '' as Headers, '' as columns , 'property_details_' as feildname, 'Text' as datatype, '' as Rateper from dual union all select  '' as Headers, 'Property' as columns , 'property_name_' as feildname, 'Text' as datatype, '' as Rateper from dual union all select  '' as Headers, 'Property Address' as columns , 'property_Address_' as feildname,'Text' as datatype, '' as Rateper from dual union all select  '' as Headers, 'Location' as columns  , 'location_name_' as feildname, 'Text' as datatype, '' as Rateper from dual union all select  '' as Headers, 'Country' as columns , 'country_name_' as feildname, 'Text' as datatype, '' as Rateper from dual union all select  '' as Headers, 'Exchange Rate' as columns , 'ExchangeRate_' as feildname, 'Text' as datatype, '' as Rateper from dual union all select  'Purchase Information' as Headers, '' as columns , '' as feildname, 'Text' as datatype, '' as Rateper from dual union all select  '' as Headers, 'Purhcase Price' as columns , 'PurhcasePrice_' as feildname, 'No' as datatype, '' as Rateper from dual union all select  '' as Headers, 'Stamp Duty' as columns , 'stampduty_' as feildname, 'No' as datatype, '' as Rateper from dual union all select  '' as Headers, 'Mortgage/Lease Registration' as columns , 'mortgageregistration_' as feildname, 'No' as datatype, '' as Rateper from dual union all select '' as Headers, 'Transfer Fees' as columns , 'transferfees_' as feildname, 'No' as datatype, '' as Rateper from dual union all select '' as Headers, 'Total Cash Requirement' as columns , 'TotalCashRequirement_' as feildname, 'No' as datatype, '' as Rateper from dual union all select  'Growth Rates' as Headers, '' as columns , '' as feildname, 'No' as datatype, '' as Rateper from dual union all select '' as Headers, 'CPI' as columns , 'cpi_' as feildname, 'format2' as datatype, 'Percentage' as Rateper from dual union all select '' as Headers, 'Rental Growth' as columns , 'rentalgrowth_' as feildname, 'format2' as datatype, 'Percentage' as Rateper from dual union all select '' as Headers, 'Capital Growth' as columns , 'capitalgrowth_' as feildname, 'format2' as datatype, 'Percentage' as Rateper from dual union all select 'IRR' as Headers, '' as columns , '' as feildname, 'No' as datatype, '' as Rateper from dual union all select '' as Headers, 'IRR' as columns , 'IRR_' as feildname, 'format2' as datatype, 'Percentage' as Rateper from dual union all select '' as Headers, 'IRR (after tax)' as columns , 'IRRAfterTax_' as feildname, 'format2' as datatype, 'Percentage' as Rateper from dual";
                ...
                <div class="card" style='display:none;' >
                    <div class="card-body">
                        <h4 class="card-title">Estimated Equity</h4>
        ...
        else
        {
            ...
            <div class="row mt-4">
                <div class="col-lg-4 col-md-6">
                    <h1 class="hero-title-dark">My Properties <span><?php echo $i-1; ?></span></h1>
                    <div class="graph-panel">
                        <canvas id="project-bar"></canvas>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <h1 class="hero-title-dark"> Portfolio Value  <span id='TotalPropertyValue' ><?php echo $CurrencySym; ?><?php echo number_format($TotalPropertyValue,0); ?></span></h1>
                    <div class="graph-panel">
                        <canvas id="top-product"></canvas>
                        <input type='hidden' name='TotalPropertyValueHidden' id='TotalPropertyValueHidden' value='<?php echo round($TotalPropertyValue); ?>' >
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <h1 class="hero-title-dark">ROI<span id="TotalYieldroi"><?php echo number_format($TotalYieldroi,2); ?>%</span></h1>
                    <div class="graph-panel">
            ...
            <div class="row mt-4">
                ...
                ?>
                <div class="col-lg-4 col-md-6">
                    <h1 class="hero-title-dark">Operational Leakage<span id="TotalYieldroi"><?php echo number_format($OperationalLeakage,2); ?>%</span></h1>
                    <div class="graph-panel">
                        <canvas id="btc-income"></canvas>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <h1 class="hero-title-dark">Gross Annual Rental<span id="TotalGrossIncome"><?php echo $CurrencySym; ?><?php echo number_format($TotalGrossIncome,0); ?></span></h1>
                    <div class="graph-panel">
                ...
                <div class="col-lg-4 col-md-6">
                    <h1 class="hero-title-dark">Net Annual Income<span id="TotalNetAnnualReturn"><?php echo $CurrencySym; ?><?php echo number_format($TotalNetAnnualReturn,0); ?></span></h1>
                    <div class="graph-panel">
            ...
            <div class="row mt-4">
                ...
                <div class="col-lg-6 col-md-6">
                    <h1 class="hero-title-dark">Net Annual Income <br> (after finance costs) <span id="TotalNetCashFlow"><?php echo $CurrencySym; ?><?php echo number_format($TotalNetCashFlow,0); ?></span></h1>
                    <div class="graph-panel">
                ...
                <div class="col-lg-6 col-md-6">
                    <h1 class="hero-title-dark">Net Annual Income <br> (after finance costs and tax) <span id="TotalNetCashFlowAfterTax"><?php echo $CurrencySym; ?><?php echo number_format($TotalNetCashFlowAfterTax,0); ?></span></h1>
                    <div class="graph-panel">
...
function GetCurrencyDecimal(number){
...
function compareCurrencyFn(){
    ...
    var CurrencieVal = $("#CurrencieVal").val();
     var ViewCompare = $("#ViewCompare").val();
     
     //alert("ViewCompare="+ViewCompare);
     //alert("CurrencieVal="+CurrencieVal);
     
     if (ViewCompare == "" || ViewCompare == undefined )
        ViewCompare = "N";
    
    
    
    document.frm.action='<?php echo SITE_BASE_URL;?>Portfolio/Portfolio.html?ViewCompare='+ViewCompare+'&IsEligible=Y&compareVal=Y&IsSameCurr='+CurrencieVal;
    document.frm.submit();
...
<script type="text/javascript">
   ...
   //console.log('PropertyStringNew='+ PropertyStringNew);


//============== Annual Cash Flow New
...
<!-- owl crousal -->
<script type="text/javascript" src="<?php echo SITE_BASE_URL;?>dashboard/assets/plugins/owl-crousal/js/owl.carousel.min.js"></script>
