...
<div class="content">
    ...
    <form action="<?php echo SITE_BASE_URL;?>Masters/SaveNewFile.html?id=<?php echo $Id; ?>&mode=upload" method="post" class="dpo-form" name='form1' enctype="multipart/form-data">
