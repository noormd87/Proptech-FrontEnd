...
//	exit();
    ...
    */
	...
	public static function PropertyDetailSite($PropertyIds){
        self::Init();
        ...
        //$PropertyIds = '17646585';
        
        curl_setopt_array($curl, array(
           //CURLOPT_URL => "https://api-uat.corelogic.asia/property-details/nz/properties/17646585/sales/last" , //. self::$Query
           
           CURLOPT_URL => "https://api-uat.corelogic.asia/property-details/nz/properties/". $PropertyIds ."/site" , //. self::$Query
        ...
        if ($err) {
          ...
          $landUsePrimary       = $RetDecode->landUsePrimary ;
          $zoneCodeLocal        = $RetDecode->zoneCodeLocal ;
          $zoneDescriptionLocal = $RetDecode->zoneDescriptionLocal ;
          
          foreach($RetDecode->siteValueList as $RetArr1)
          {
              
              $PropertyDate    = $RetArr1->date;
              $Propertytype    = $RetArr1->type;
              $valuationNumber = $RetArr1->valuationNumber;
              $assessmentDate  = $RetArr1->assessmentDate;
              $value           = $RetArr1->value;
              
               $RetArr[] = array( "PropertyDate" => $PropertyDate,
                              "Propertytype" => $Propertytype,
                              "valuationNumber" => $valuationNumber,
                              "assessmentDate" => $assessmentDate,
                              "value" => $value,
                              "zoneDescriptionLocal" => $zoneDescriptionLocal
	...
	//================================== Property Detail Core ========================================
	
	public static function PropertyDetailCore($PropertyIds){
        self::Init();
       ...
       // $PropertyIds = '17646585';
        ...
        curl_setopt_array($curl, array(
           ...
           CURLOPT_URL => "https://api-uat.corelogic.asia/property-details/nz/properties/17646585/attributes/core" , //. self::$Query
        ...
        if ($err) {
          ...
          $propertyType             = $RetDecode->propertyType ;
          $propertySubType          = $RetDecode->propertySubType ;
          $propertySubTypeShort     = $RetDecode->propertySubTypeShort ;
          $beds                     = $RetDecode->beds ;
          $baths                    = $RetDecode->baths ;
          $carSpaces                = $RetDecode->carSpaces ;
          $lockUpGarages            = $RetDecode->lockUpGarages ;
          $landArea                 = $RetDecode->landArea ;
          $isCalculatedLandArea     = $RetDecode->isCalculatedLandArea ;
          $landAreaSource           = $RetDecode->landAreaSource ;
          
     
          $RetArr[] = array( "CategoryType" => $propertyType,
                              "CategorySubType" => $propertySubType,
                              "CategorySubTypeShort" => $propertySubTypeShort,
                              "beds" => $beds,
                              "baths" => $baths,
                              "carSpaces" => $carSpaces,
	...
	public static function PropertyDetailadditional($PropertyIds){
        self::Init();
       ...
       // $PropertyIds = '17646585';
        ...
        curl_setopt_array($curl, array(
          ...
          CURLOPT_URL => "https://api-uat.corelogic.asia/property-details/nz/properties/".$PropertyIds."/attributes/additional" , //. self::$Query
        ...
        if ($err) {
          ...
          $floorArea             = $RetDecode->floorArea ;
          $siteCover          = $RetDecode->siteCover ;
          $unitsOfUse     = $RetDecode->unitsOfUse ;
          $salesGroupId                     = $RetDecode->salesGroupId ;
          $salesGroupName                    = $RetDecode->salesGroupName ;
         
          $RetArr[] = array( "floorArea" => $floorArea,
                              "siteCover" => $siteCover,
	...
	public static function PropertyDetailImage($PropertyIds){
        self::Init();
       ...
       // $PropertyIds = '14839057';
        
        curl_setopt_array($curl, array(
           //CURLOPT_URL => "https://api-uat.corelogic.asia/property-details/nz/properties/17646585/sales/last" , //. self::$Query
           
          CURLOPT_URL => "https://api-uat.corelogic.asia/property-details/nz/properties/". $PropertyIds ."/images/default" , //. self::$Query
        ...
        if ($err) {
          ...
          $basePhotoUrl         = $RetDecode->basePhotoUrl ;
          $digitalAssetType     = $RetDecode->digitalAssetType ;
          $largePhotoUrl        = $RetDecode->largePhotoUrl ;
          $mediumPhotoUrl       = $RetDecode->mediumPhotoUrl ;
          $scanDate             = $RetDecode->scanDate ;
          $thumbnailPhotoUrl    = $RetDecode->thumbnailPhotoUrl ;
         
          $RetArr[] = array( "basePhotoUrl" => $basePhotoUrl,
	...
	public static function PropertyDetailCurrent($PropertyIds){
        self::Init();
        ...
        curl_setopt_array($curl, array(
           ...
           CURLOPT_URL => "https://api-uat.corelogic.asia/titles/nz/properties/". $PropertyIds ."/titles/current" , //. self::$Query
        ...
        if ($err) {
          ...
          $Owner          =  $RetDecode->titles->owners->corporateName ? $RetDecode->titles->owners->corporateName : "";
          $Title          =  $RetDecode->titles->titleDescription->type ? $RetDecode->titles->titleDescription->type : "";
         
              
           $RetArr[] = array( "Owner" => $Owner,
                          "Title" => $Title
                          );        
        }
	...
	public static function PropertyDetailLast($PropertyIds){
        self::Init();
        ...
        curl_setopt_array($curl, array(
           CURLOPT_URL => "https://api-uat.corelogic.asia/property-details/nz/properties/".$PropertyIds."/sales/last" , //. self::$Query
        ...
        if ($err) {
          ...
          $lastOfficalPrice      = $RetDecode->lastSale->price ? $RetDecode->lastSale->price  : "";
          $settlementDate       = $RetDecode->lastSale->settlementDate ? $RetDecode->lastSale->settlementDate  : "";
          $type                 = $RetDecode->lastSale->type ? $RetDecode->lastSale->type  : "";
          $netPrice             = $RetDecode->lastSale->netPrice ? $RetDecode->lastSale->netPrice  : ""; 
          $chattelsPrice        = $RetDecode->lastSale->chattelsPrice ? $RetDecode->lastSale->chattelsPrice  : "";
          
            
          $RetArr[] = array( "lastOfficalPrice" => $lastOfficalPrice ,
                      "settlementDate" => $settlementDate,
                      "LastOfficialSaleType" => $type,
                      "netPrice" => $netPrice,
                      "chattelsPrice" => $chattelsPrice
	...
	//==========================================================================
    	...
    	//================================== CopyRightsApi Details ========================================
	
	public static function CopyRightsApiDetails($countryCode=1,$path="C"){
        self::Init();
        ...
        if($countryCode == 1 && $path == "C" )
             $url = "https://api-uat.corelogic.asia/content/legal/copyrights/clCopyright_nz";
        elseif($countryCode == 1 && $path == "D" )
            $url = "https://api-uat.corelogic.asia/content/legal/disclaimers/cl_nz";
        elseif($countryCode == 2 && $path == "C" )
            $url = "https://api-uat.corelogic.asia/content/legal/copyrights/clCopyright_au";
        elseif($countryCode == 2 && $path == "D" )
            $url = "https://api-uat.corelogic.asia/content/legal/disclaimers/cl_au";
...
//exit;
        ...
        if ($err) {
          ...
          $content      = $RetDecode->content ? $RetDecode->content  : "";
