    ...
    */
	...
	public static function FeatureCommonApiUkValueAjax($GraphDetails,$locationId,$DataSrc,$datefilter1,$datefilter2,$m="0",$ProductName="",$graphpoint="D")
	{
       ...
       // exit;
        ...
        $TotAreaLeverage =  $TotAreaLeverage / $i ;
        $TotDebtPerBuilding=  $TotDebtPerBuilding / $i ;
        $TotMortgageLending=  $TotMortgageLending / $i ;
        $TotCreditScore=  $TotCreditScore / $i ;
        $TotMeanIncome=  $TotMeanIncome / $i ;
        $TotHomelessnessCount=  $TotHomelessnessCount / $i ;
        $TotRepossessionsCount=  $TotRepossessionsCount / $i ;
        $TotUnemploymentLevel=  $TotUnemploymentLevel / $i ;
        $TotViolentSexualCrimes=  $TotViolentSexualCrimes / $i ;
        $TotCrimesDishonesty=  $TotCrimesDishonesty / $i ;
        $TotOtherCrimes=  $TotOtherCrimes / $i ;
        $TotMortgageDebtPerCapital=  $TotMortgageDebtPerCapital / $i ;
        $TotBusStationsStops=  $TotBusStationsStops / $i ;
        $TotNationalRailStations=  $TotNationalRailStations / $i ;
        $TotDwellings=  $TotDwellings / $i ;
        $TotBroadbandSpeed=  $TotBroadbandSpeed / $i ;
        ...
        //exit;
         ...
         $IsValCmg = 0;
          ...
          foreach($RetDecode->data as $RetArr1){
                ...
                if($dateAppeared !="" )
                    $dateAppeared   = date('d-M-Y', $dateAppeared);
                    
                if($dateRemoved !="" )
                    $dateRemoved   = date('d-M-Y', $dateRemoved);
                    
                if($dateSold !="" )
                    $dateSold   = date('d-M-Y', $dateSold);
